...
// modularised, will import { G } from '../state/game.js?v=152' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=152';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=152';
