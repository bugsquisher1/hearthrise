...
import { levelFromXp } from './xp.js?v=498';
import { pacedXp } from './pacing.js?v=498';
import { spendRestedCharge } from './rested.js?v=498';
import { advanceToolCarry } from './tools.js?v=498';
