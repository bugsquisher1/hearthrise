...
//   import { setupSync } from './net/sync.js?v=452';
//   setupSync({
...
import { on, snapshot } from './events.js?v=452';
...
import { resolveActiveSlot } from './accrue.js?v=452';
...
import { balanceState } from './balance.js?v=452';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=452';
import { putClientState } from './client-state.js?v=452';
