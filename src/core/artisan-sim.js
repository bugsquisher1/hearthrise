...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=500';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=500';
import { actionIntervalMs } from './pacing.js?v=500';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=500';
import { sliceSpan } from './skill-sim.js?v=500';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=500';
import { levelOf } from './xp.js?v=500';
