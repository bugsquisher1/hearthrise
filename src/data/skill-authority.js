...
import { SKILLS_DEF } from './skills.js?v=497';
import { COMBAT_STYLES } from '../core/styles.js?v=497';
import { GATHER_SKILLS } from '../core/pacing.js?v=497';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=497';
