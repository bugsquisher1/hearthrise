...
import { SKILLS_DEF } from './skills.js?v=518';
import { COMBAT_STYLES } from '../core/styles.js?v=518';
import { GATHER_SKILLS } from '../core/pacing.js?v=518';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=518';
