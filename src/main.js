...
import { SKILLS_DEF } from './data/skills.js?v=361';
import { MONSTERS } from './data/monsters.js?v=361';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster } from './data/monster-classes.js?v=361';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=361';
import * as ItemArt from './data/item-art.js?v=361';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=361';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=361';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=361';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=361';
import { COMPANIONS } from './data/companions.js?v=361';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=361';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=361';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=361';
...
import './net/events.js?v=361';
import './net/sync.js?v=361';
...
import './net/gold.js?v=361';
import './net/auth.js?v=361';
import './net/supabase-bootstrap.js?v=361';
...
import './net/build-watch.js?v=361';
...
import './config.js?v=361';
import './utils/dom.js?v=361';
import './utils/safe.js?v=361';
import './utils/profile.js?v=361';
import './utils/data-integrity.js?v=361';
import './utils/image-fallback.js?v=361';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=361';
import { setupCompanions } from './features/companions.js?v=361';
import { setupActivitiesGrid } from './features/activities-grid.js?v=361';
import { setupCharacterPage } from './features/character-page.js?v=361';
import { setupCombatRender } from './features/combat-render.js?v=361';
import { setupRecipeBook } from './features/recipe-book.js?v=361';
import { setupItemIndex } from './features/item-index.js?v=361';
