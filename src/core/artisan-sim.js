...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=534';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=534';
import { actionIntervalMs } from './pacing.js?v=534';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=534';
import { sliceSpan } from './skill-sim.js?v=534';
