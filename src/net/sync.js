...
//   import { setupSync } from './net/sync.js?v=464';
//   setupSync({
...
import { on, snapshot } from './events.js?v=464';
...
import { resolveActiveSlot } from './accrue.js?v=464';
...
import { balanceState } from './balance.js?v=464';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=464';
import { putClientState } from './client-state.js?v=464';
