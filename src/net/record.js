...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits } from './accrue.js?v=463';
...
import { applyClientState } from './client-state.js?v=463';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=463';
