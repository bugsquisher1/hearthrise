...
import { SKILLS_DEF } from './data/skills.js?v=275';
import { MONSTERS } from './data/monsters.js?v=275';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=275';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=275';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=275';
import { COMPANIONS } from './data/companions.js?v=275';
...
import './net/events.js?v=275';
import './net/sync.js?v=275';
import './net/auth.js?v=275';
import './net/supabase-bootstrap.js?v=275';
...
import './config.js?v=275';
import './utils/dom.js?v=275';
import './utils/safe.js?v=275';
import './utils/profile.js?v=275';
import './utils/data-integrity.js?v=275';
import './utils/image-fallback.js?v=275';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=275';
import { setupCompanions } from './features/companions.js?v=275';
import { setupActivitiesGrid } from './features/activities-grid.js?v=275';
import { setupCharacterPage } from './features/character-page.js?v=275';
import { setupCombatRender } from './features/combat-render.js?v=275';
import { setupRecipeBook } from './features/recipe-book.js?v=275';
import { setupItemIndex } from './features/item-index.js?v=275';
