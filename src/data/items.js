...
import { GEAR_ITEMS } from './gear-tiers.js?v=487';
import { WAVE3_ITEMS } from './wave3-uniques.js?v=487';
import { SLOT_ITEMS } from './slot-ladders.js?v=487';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=487';
import { LIB2_ITEMS } from './library2-items.js?v=487';
import { STONECRAFT_ITEMS } from './stonecraft.js?v=487';
