...
//   import { setupSync } from './net/sync.js?v=399';
//   setupSync({
...
import { on, snapshot } from './events.js?v=399';
...
import { resolveActiveSlot } from './accrue.js?v=399';
...
import { balanceState } from './balance.js?v=399';
