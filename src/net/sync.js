...
//   import { setupSync } from './net/sync.js?v=384';
//   setupSync({
...
import { on, snapshot } from './events.js?v=384';
...
import { resolveActiveSlot } from './accrue.js?v=384';
...
import { balanceState } from './balance.js?v=384';
