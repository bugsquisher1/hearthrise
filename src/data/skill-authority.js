...
import { SKILLS_DEF } from './skills.js?v=402';
import { COMBAT_STYLES } from '../core/styles.js?v=402';
import { GATHER_SKILLS } from '../core/pacing.js?v=402';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=402';
