...
//   import { setupSync } from './net/sync.js?v=490';
//   setupSync({
...
import { on, snapshot } from './events.js?v=490';
...
import { resolveActiveSlot } from './accrue.js?v=490';
...
import { balanceState } from './balance.js?v=490';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=490';
import { putClientState } from './client-state.js?v=490';
