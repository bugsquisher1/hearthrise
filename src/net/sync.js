...
//   import { setupSync } from './net/sync.js?v=468';
//   setupSync({
...
import { on, snapshot } from './events.js?v=468';
...
import { resolveActiveSlot } from './accrue.js?v=468';
...
import { balanceState } from './balance.js?v=468';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=468';
import { putClientState } from './client-state.js?v=468';
