...
import { MONSTERS } from './data/monsters.js?v=354';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=354';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=354';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=354';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=354';
import { COMPANIONS } from './data/companions.js?v=354';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=354';
...
import './net/events.js?v=354';
import './net/sync.js?v=354';
...
import './net/gold.js?v=354';
import './net/auth.js?v=354';
import './net/supabase-bootstrap.js?v=354';
...
import './net/build-watch.js?v=354';
...
import './config.js?v=354';
import './utils/dom.js?v=354';
import './utils/safe.js?v=354';
import './utils/profile.js?v=354';
import './utils/data-integrity.js?v=354';
import './utils/image-fallback.js?v=354';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=354';
import { setupCompanions } from './features/companions.js?v=354';
import { setupActivitiesGrid } from './features/activities-grid.js?v=354';
import { setupCharacterPage } from './features/character-page.js?v=354';
import { setupCombatRender } from './features/combat-render.js?v=354';
import { setupRecipeBook } from './features/recipe-book.js?v=354';
import { setupItemIndex } from './features/item-index.js?v=354';
