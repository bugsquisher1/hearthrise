...
// modularised, will import { G } from '../state/game.js?v=189' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=189';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=189';
