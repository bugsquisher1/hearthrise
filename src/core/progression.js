...
import { levelFromXp } from './xp.js?v=494';
import { pacedXp } from './pacing.js?v=494';
import { spendRestedCharge } from './rested.js?v=494';
import { advanceToolCarry } from './tools.js?v=494';
