...
// modularised, will import { G } from '../state/game.js?v=196' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=196';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=196';
