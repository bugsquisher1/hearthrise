...
import { resolveGatherAction } from './progression.js?v=528';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=528';
import { actionIntervalMs, MIN_ACTION_MS, GATHER_SKILLS } from './pacing.js?v=528';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=528';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=528';
import { levelOf } from './xp.js?v=528';
