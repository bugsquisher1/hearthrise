...
import { applyClientState } from './client-state.js?v=510';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=510';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=510';
