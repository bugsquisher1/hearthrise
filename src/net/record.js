...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots, reconcileHp, reconcileEventCounters } from './accrue.js?v=517';
...
import { applyClientState } from './client-state.js?v=517';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=517';
