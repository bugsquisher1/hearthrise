...
import { levelFromXp } from './xp.js?v=404';
import { pacedXp } from './pacing.js?v=404';
import { spendRestedCharge } from './rested.js?v=404';
import { advanceToolCarry } from './tools.js?v=404';
