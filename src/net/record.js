...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileWorkers } from './accrue.js?v=479';
...
import { applyClientState } from './client-state.js?v=479';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=479';
