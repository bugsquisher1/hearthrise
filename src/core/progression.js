...
import { levelFromXp } from './xp.js?v=449';
import { pacedXp } from './pacing.js?v=449';
import { spendRestedCharge } from './rested.js?v=449';
import { advanceToolCarry } from './tools.js?v=449';
