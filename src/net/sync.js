...
//   import { setupSync } from './net/sync.js?v=365';
//   setupSync({
...
import { on, snapshot } from './events.js?v=365';
...
import { resolveActiveSlot } from './accrue.js?v=365';
...
import { balanceState } from './balance.js?v=365';
