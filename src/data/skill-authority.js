...
import { SKILLS_DEF } from './skills.js?v=457';
import { COMBAT_STYLES } from '../core/styles.js?v=457';
import { GATHER_SKILLS } from '../core/pacing.js?v=457';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=457';
