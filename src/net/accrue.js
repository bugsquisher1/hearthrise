...
import * as itemLedger from './item-ledger.js?v=510';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=510';
...
import * as pendingConsume from './pending-consume.js?v=510';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=510';
...
import { notePropertyUnlocks, pickBankRung, isCompleteProgressStatement } from './property-record.js?v=510';
