...
// modularised, will import { G } from '../state/game.js?v=160' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=160';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=160';
