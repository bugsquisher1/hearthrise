...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots, reconcileHp, reconcileEventCounters } from './accrue.js?v=515';
...
import { applyClientState } from './client-state.js?v=515';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=515';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=515';
