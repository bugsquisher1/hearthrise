...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=427';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=427';
import { actionIntervalMs } from './pacing.js?v=427';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=427';
import { sliceSpan } from './skill-sim.js?v=427';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=427';
import { levelOf } from './xp.js?v=427';
