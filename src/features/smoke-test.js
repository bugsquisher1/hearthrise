...
// modularised, will import { G } from '../state/game.js?v=154' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=154';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=154';
