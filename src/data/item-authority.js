...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=552';
import { ARTISAN_RECIPES } from './recipes.js?v=552';
import { MONSTERS } from './monsters.js?v=552';
import { BOSSES } from './bosses.js?v=552';
import { ITEMS } from './items.js?v=552';
...
import { QM_STOCK } from './dungeons.js?v=552';
import { SHOP_OFFERS } from './shops.js?v=552';
import { QUEST_REWARDS, DAILY_TASK_REWARDS } from './goal-catalogue.js?v=552';
import { RAID_BOSSES } from './raid-bosses.js?v=552';
...
import { BURNT_ITEM } from '../core/artisan.js?v=552';
