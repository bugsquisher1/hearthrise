...
//   import { setupSync } from './net/sync.js?v=409';
//   setupSync({
...
import { on, snapshot } from './events.js?v=409';
...
import { resolveActiveSlot } from './accrue.js?v=409';
...
import { balanceState } from './balance.js?v=409';
