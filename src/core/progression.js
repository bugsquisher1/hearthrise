...
import { levelFromXp } from './xp.js?v=536';
import { pacedXp } from './pacing.js?v=536';
import { spendRestedCharge } from './rested.js?v=536';
import { advanceToolCarry } from './tools.js?v=536';
