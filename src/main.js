...
import { SKILLS_DEF } from './data/skills.js?v=441';
import { MONSTERS } from './data/monsters.js?v=441';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=441';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=441';
import * as ItemArt from './data/item-art.js?v=441';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=441';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=441';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=441';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=441';
import { COMPANIONS } from './data/companions.js?v=441';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=441';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=441';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=441';
...
import './net/events.js?v=441';
import './net/sync.js?v=441';
...
import './net/dungeon-purchase.js?v=441';
...
import './net/skill-record.js?v=441';
...
import './net/marks-record.js?v=441';
...
import './net/market-history.js?v=441';
import './net/auth.js?v=441';
import './net/supabase-bootstrap.js?v=441';
...
import './net/build-watch.js?v=441';
...
import './config.js?v=441';
import './utils/dom.js?v=441';
import './utils/safe.js?v=441';
import './utils/profile.js?v=441';
import './utils/data-integrity.js?v=441';
import './utils/image-fallback.js?v=441';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=441';
import { setupCompanions } from './features/companions.js?v=441';
import { setupActivitiesGrid } from './features/activities-grid.js?v=441';
import { setupCharacterPage } from './features/character-page.js?v=441';
import { setupCombatRender } from './features/combat-render.js?v=441';
import { setupCombatScreens } from './features/combat-screens.js?v=441';
import { setupRecipeBook } from './features/recipe-book.js?v=441';
import { setupItemIndex } from './features/item-index.js?v=441';
