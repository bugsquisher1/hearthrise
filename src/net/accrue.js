...
import * as itemLedger from './item-ledger.js?v=480';
...
import { serverOwnedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=480';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=480';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=480';
