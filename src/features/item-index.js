...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=251';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=251';
import { ITEM_DESC } from '../data/item-descriptions.js?v=251';
