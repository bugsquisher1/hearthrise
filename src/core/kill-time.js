...
import { COMBAT_BALANCE } from './combat.js?v=507';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=507';
import { TOTAL_CAP } from './perks.js?v=507';
import { COMBAT_STYLES } from './styles.js?v=507';
import { ITEMS } from '../data/items.js?v=507';
