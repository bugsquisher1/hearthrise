...
import { SKILLS_DEF } from './skills.js?v=548';
import { COMBAT_STYLES } from '../core/styles.js?v=548';
import { GATHER_SKILLS } from '../core/pacing.js?v=548';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=548';
