...
import { levelFromXp } from './xp.js?v=483';
import { pacedXp } from './pacing.js?v=483';
import { spendRestedCharge } from './rested.js?v=483';
import { advanceToolCarry } from './tools.js?v=483';
