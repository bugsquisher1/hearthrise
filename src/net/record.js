...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits } from './accrue.js?v=462';
...
import { applyClientState } from './client-state.js?v=462';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=462';
