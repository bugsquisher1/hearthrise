...
//   import { setupSync } from './net/sync.js?v=494';
//   setupSync({
...
import { on, snapshot } from './events.js?v=494';
...
import { resolveActiveSlot } from './accrue.js?v=494';
...
import { balanceState } from './balance.js?v=494';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=494';
import { putClientState } from './client-state.js?v=494';
