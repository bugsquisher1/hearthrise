...
//   import { setupSync } from './net/sync.js?v=405';
//   setupSync({
...
import { on, snapshot } from './events.js?v=405';
...
import { resolveActiveSlot } from './accrue.js?v=405';
...
import { balanceState } from './balance.js?v=405';
