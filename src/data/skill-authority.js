...
import { SKILLS_DEF } from './skills.js?v=463';
import { COMBAT_STYLES } from '../core/styles.js?v=463';
import { GATHER_SKILLS } from '../core/pacing.js?v=463';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=463';
