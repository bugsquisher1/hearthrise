...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=520';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=520';
import { actionIntervalMs } from './pacing.js?v=520';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=520';
import { sliceSpan } from './skill-sim.js?v=520';
