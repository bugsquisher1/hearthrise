...
import { MONSTERS } from './data/monsters.js?v=236';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=236';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=236';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=236';
import { COMPANIONS } from './data/companions.js?v=236';
...
import './net/events.js?v=236';
import './net/sync.js?v=236';
import './net/auth.js?v=236';
import './net/supabase-bootstrap.js?v=236';
...
import './config.js?v=236';
import './utils/dom.js?v=236';
import './utils/safe.js?v=236';
import './utils/profile.js?v=236';
import './utils/data-integrity.js?v=236';
import './utils/image-fallback.js?v=236';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=236';
import { setupCompanions } from './features/companions.js?v=236';
import { setupActivitiesGrid } from './features/activities-grid.js?v=236';
import { setupCharacterPage } from './features/character-page.js?v=236';
import { setupCombatRender } from './features/combat-render.js?v=236';
