...
//   import { setupSync } from './net/sync.js?v=497';
//   setupSync({
...
import { on, snapshot } from './events.js?v=497';
...
import { resolveActiveSlot } from './accrue.js?v=497';
...
import { balanceState } from './balance.js?v=497';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=497';
import { putClientState } from './client-state.js?v=497';
