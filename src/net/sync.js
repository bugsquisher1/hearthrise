...
//   import { setupSync } from './net/sync.js?v=510';
//   setupSync({
...
import { on, snapshot } from './events.js?v=510';
...
import { resolveActiveSlot } from './accrue.js?v=510';
...
import { balanceState } from './balance.js?v=510';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=510';
import { putClientState } from './client-state.js?v=510';
