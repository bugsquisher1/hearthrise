...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank } from './accrue.js?v=474';
...
import { applyClientState } from './client-state.js?v=474';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=474';
