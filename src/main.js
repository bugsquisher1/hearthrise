...
import { SKILLS_DEF } from './data/skills.js?v=234';
import { MONSTERS } from './data/monsters.js?v=234';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=234';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=234';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=234';
import { COMPANIONS } from './data/companions.js?v=234';
...
import './net/events.js?v=234';
import './net/sync.js?v=234';
import './net/auth.js?v=234';
import './net/supabase-bootstrap.js?v=234';
...
import './config.js?v=234';
import './utils/dom.js?v=234';
import './utils/safe.js?v=234';
import './utils/profile.js?v=234';
import './utils/data-integrity.js?v=234';
import './utils/image-fallback.js?v=234';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=234';
import { setupCompanions } from './features/companions.js?v=234';
import { setupActivitiesGrid } from './features/activities-grid.js?v=234';
import { setupCharacterPage } from './features/character-page.js?v=234';
import { setupCombatRender } from './features/combat-render.js?v=234';
