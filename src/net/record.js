...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm } from './accrue.js?v=460';
...
import { applyClientState } from './client-state.js?v=460';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=460';
