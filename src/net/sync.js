...
//   import { setupSync } from './net/sync.js?v=444';
//   setupSync({
...
import { on, snapshot } from './events.js?v=444';
...
import { resolveActiveSlot } from './accrue.js?v=444';
...
import { balanceState } from './balance.js?v=444';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=444';
import { putClientState } from './client-state.js?v=444';
