...
import { SKILLS_DEF } from './data/skills.js?v=501';
import { MONSTERS } from './data/monsters.js?v=501';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=501';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=501';
import * as ItemArt from './data/item-art.js?v=501';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=501';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=501';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=501';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=501';
import { COMPANIONS } from './data/companions.js?v=501';
import { RAID_BOSSES } from './data/raid-bosses.js?v=501';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=501';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=501';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=501';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=501';
...
import './net/events.js?v=501';
import './net/sync.js?v=501';
...
import './net/dungeon-purchase.js?v=501';
...
import './net/predict.js?v=501';
import './net/record.js?v=501';
...
import './net/skill-record.js?v=501';
...
import './net/marks-record.js?v=501';
...
import './net/rooms-record.js?v=501';
...
import './net/property-record.js?v=501';
...
import './net/rested-record.js?v=501';
...
import './net/equipment-record.js?v=501';
...
import './net/market-history.js?v=501';
import './net/auth.js?v=501';
import './net/supabase-bootstrap.js?v=501';
...
import './features/boot-hydration.js?v=501';
...
import './net/build-watch.js?v=501';
...
import './config.js?v=501';
import './utils/dom.js?v=501';
import './utils/safe.js?v=501';
import './utils/profile.js?v=501';
import './utils/data-integrity.js?v=501';
import './utils/image-fallback.js?v=501';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=501';
import { setupCompanions } from './features/companions.js?v=501';
import { setupActivitiesGrid } from './features/activities-grid.js?v=501';
import { setupCharacterPage } from './features/character-page.js?v=501';
import { setupCombatRender } from './features/combat-render.js?v=501';
import { setupCombatScreens } from './features/combat-screens.js?v=501';
import { setupRecipeBook } from './features/recipe-book.js?v=501';
import { setupItemIndex } from './features/item-index.js?v=501';
