...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileWorkers } from './accrue.js?v=494';
...
import { applyClientState } from './client-state.js?v=494';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=494';
