...
import { SKILLS_DEF } from './skills.js?v=433';
import { COMBAT_STYLES } from '../core/styles.js?v=433';
import { GATHER_SKILLS } from '../core/pacing.js?v=433';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=433';
