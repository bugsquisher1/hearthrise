...
//   import { setupSync } from './net/sync.js?v=388';
//   setupSync({
...
import { on, snapshot } from './events.js?v=388';
...
import { resolveActiveSlot } from './accrue.js?v=388';
...
import { balanceState } from './balance.js?v=388';
