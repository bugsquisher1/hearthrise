...
import { SKILLS_DEF } from './data/skills.js?v=530';
import { MONSTERS } from './data/monsters.js?v=530';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=530';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=530';
import * as ItemArt from './data/item-art.js?v=530';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=530';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=530';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=530';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=530';
import { COMPANIONS } from './data/companions.js?v=530';
import { RAID_BOSSES } from './data/raid-bosses.js?v=530';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=530';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=530';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=530';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=530';
...
import './net/events.js?v=530';
import './net/sync.js?v=530';
...
import './net/dungeon-purchase.js?v=530';
...
import './net/predict.js?v=530';
import './net/record.js?v=530';
...
import './net/skill-record.js?v=530';
...
import './net/marks-record.js?v=530';
...
import './net/rooms-record.js?v=530';
...
import './net/property-record.js?v=530';
...
import './net/rested-record.js?v=530';
...
import './net/equipment-record.js?v=530';
...
import './net/dungeon-scrip-record.js?v=530';
import './net/dungeon-settle.js?v=530';
...
import './net/market-history.js?v=530';
import './net/auth.js?v=530';
import './net/supabase-bootstrap.js?v=530';
...
import './features/boot-hydration.js?v=530';
...
import './net/build-watch.js?v=530';
...
import './config.js?v=530';
import './utils/dom.js?v=530';
import './utils/safe.js?v=530';
import './utils/profile.js?v=530';
import './utils/data-integrity.js?v=530';
...
import { setupCharacterPage } from './features/character-page.js?v=530';
import { setupCombatRender } from './features/combat-render.js?v=530';
import { setupCombatScreens } from './features/combat-screens.js?v=530';
import { setupRecipeBook } from './features/recipe-book.js?v=530';
import { setupItemIndex } from './features/item-index.js?v=530';
