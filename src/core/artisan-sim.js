...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=356';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=356';
import { actionIntervalMs } from './pacing.js?v=356';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=356';
import { sliceSpan } from './skill-sim.js?v=356';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=356';
