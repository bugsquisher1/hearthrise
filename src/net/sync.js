...
//   import { setupSync } from './net/sync.js?v=419';
//   setupSync({
...
import { on, snapshot } from './events.js?v=419';
...
import { resolveActiveSlot } from './accrue.js?v=419';
...
import { balanceState } from './balance.js?v=419';
