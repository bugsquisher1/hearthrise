...
import { ARTISAN_RECIPES } from './recipes.js?v=555';
import { MONSTERS } from './monsters.js?v=555';
import { BOSSES } from './bosses.js?v=555';
import { ITEMS } from './items.js?v=555';
...
import { QM_STOCK } from './dungeons.js?v=555';
import { SHOP_OFFERS } from './shops.js?v=555';
import { QUEST_REWARDS, DAILY_TASK_REWARDS } from './goal-catalogue.js?v=555';
import { RAID_BOSSES } from './raid-bosses.js?v=555';
...
import { BURNT_ITEM } from '../core/artisan.js?v=555';
