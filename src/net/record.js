...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots } from './accrue.js?v=508';
...
import { applyClientState } from './client-state.js?v=508';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=508';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=508';
