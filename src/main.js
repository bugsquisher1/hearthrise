...
import { SKILLS_DEF } from './data/skills.js?v=272';
import { MONSTERS } from './data/monsters.js?v=272';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=272';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=272';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=272';
import { COMPANIONS } from './data/companions.js?v=272';
...
import './net/events.js?v=272';
import './net/sync.js?v=272';
import './net/auth.js?v=272';
import './net/supabase-bootstrap.js?v=272';
...
import './config.js?v=272';
import './utils/dom.js?v=272';
import './utils/safe.js?v=272';
import './utils/profile.js?v=272';
import './utils/data-integrity.js?v=272';
import './utils/image-fallback.js?v=272';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=272';
import { setupCompanions } from './features/companions.js?v=272';
import { setupActivitiesGrid } from './features/activities-grid.js?v=272';
import { setupCharacterPage } from './features/character-page.js?v=272';
import { setupCombatRender } from './features/combat-render.js?v=272';
import { setupRecipeBook } from './features/recipe-book.js?v=272';
import { setupItemIndex } from './features/item-index.js?v=272';
