...
import * as itemLedger from './item-ledger.js?v=492';
...
import { serverOwnedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=492';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=492';
...
import * as pendingConsume from './pending-consume.js?v=492';
