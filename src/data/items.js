...
import { GEAR_ITEMS } from './gear-tiers.js?v=525';
import { WAVE3_ITEMS } from './wave3-uniques.js?v=525';
import { SLOT_ITEMS } from './slot-ladders.js?v=525';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=525';
import { LIB2_ITEMS } from './library2-items.js?v=525';
import { STONECRAFT_ITEMS } from './stonecraft.js?v=525';
