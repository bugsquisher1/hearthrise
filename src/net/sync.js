...
//   import { setupSync } from './net/sync.js?v=511';
//   setupSync({
...
import { on, snapshot } from './events.js?v=511';
...
import { resolveActiveSlot } from './accrue.js?v=511';
...
import { balanceState } from './balance.js?v=511';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=511';
import { putClientState } from './client-state.js?v=511';
