...
import { SKILLS_DEF } from './data/skills.js?v=413';
import { MONSTERS } from './data/monsters.js?v=413';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=413';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=413';
import * as ItemArt from './data/item-art.js?v=413';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=413';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=413';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=413';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=413';
import { COMPANIONS } from './data/companions.js?v=413';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=413';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=413';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=413';
...
import './net/events.js?v=413';
import './net/sync.js?v=413';
...
import './net/dungeon-purchase.js?v=413';
...
import './net/market-history.js?v=413';
import './net/auth.js?v=413';
import './net/supabase-bootstrap.js?v=413';
...
import './net/build-watch.js?v=413';
...
import './config.js?v=413';
import './utils/dom.js?v=413';
import './utils/safe.js?v=413';
import './utils/profile.js?v=413';
import './utils/data-integrity.js?v=413';
import './utils/image-fallback.js?v=413';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=413';
import { setupCompanions } from './features/companions.js?v=413';
import { setupActivitiesGrid } from './features/activities-grid.js?v=413';
import { setupCharacterPage } from './features/character-page.js?v=413';
import { setupCombatRender } from './features/combat-render.js?v=413';
import { setupCombatScreens } from './features/combat-screens.js?v=413';
import { setupRecipeBook } from './features/recipe-book.js?v=413';
import { setupItemIndex } from './features/item-index.js?v=413';
