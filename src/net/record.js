...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots } from './accrue.js?v=506';
...
import { applyClientState } from './client-state.js?v=506';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=506';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=506';
