...
import { SKILLS_DEF } from './data/skills.js?v=241';
import { MONSTERS } from './data/monsters.js?v=241';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=241';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=241';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=241';
import { COMPANIONS } from './data/companions.js?v=241';
...
import './net/events.js?v=241';
import './net/sync.js?v=241';
import './net/auth.js?v=241';
import './net/supabase-bootstrap.js?v=241';
...
import './config.js?v=241';
import './utils/dom.js?v=241';
import './utils/safe.js?v=241';
import './utils/profile.js?v=241';
import './utils/data-integrity.js?v=241';
import './utils/image-fallback.js?v=241';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=241';
import { setupCompanions } from './features/companions.js?v=241';
import { setupActivitiesGrid } from './features/activities-grid.js?v=241';
import { setupCharacterPage } from './features/character-page.js?v=241';
import { setupCombatRender } from './features/combat-render.js?v=241';
import { setupRecipeBook } from './features/recipe-book.js?v=241';
