...
import { SKILLS_DEF } from './data/skills.js?v=395';
import { MONSTERS } from './data/monsters.js?v=395';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=395';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=395';
import * as ItemArt from './data/item-art.js?v=395';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=395';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=395';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=395';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=395';
import { COMPANIONS } from './data/companions.js?v=395';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=395';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=395';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=395';
...
import './net/events.js?v=395';
import './net/sync.js?v=395';
...
import './net/dungeon-purchase.js?v=395';
...
import './net/market-history.js?v=395';
import './net/auth.js?v=395';
import './net/supabase-bootstrap.js?v=395';
...
import './net/build-watch.js?v=395';
...
import './config.js?v=395';
import './utils/dom.js?v=395';
import './utils/safe.js?v=395';
import './utils/profile.js?v=395';
import './utils/data-integrity.js?v=395';
import './utils/image-fallback.js?v=395';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=395';
import { setupCompanions } from './features/companions.js?v=395';
import { setupActivitiesGrid } from './features/activities-grid.js?v=395';
import { setupCharacterPage } from './features/character-page.js?v=395';
import { setupCombatRender } from './features/combat-render.js?v=395';
import { setupCombatScreens } from './features/combat-screens.js?v=395';
import { setupRecipeBook } from './features/recipe-book.js?v=395';
import { setupItemIndex } from './features/item-index.js?v=395';
