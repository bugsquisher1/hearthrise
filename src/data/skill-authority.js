...
import { SKILLS_DEF } from './skills.js?v=456';
import { COMBAT_STYLES } from '../core/styles.js?v=456';
import { GATHER_SKILLS } from '../core/pacing.js?v=456';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=456';
