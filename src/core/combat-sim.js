...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=546';
import { rollDropTable } from './drops.js?v=546';
import { resolveHearthfind } from './hearthfind.js?v=546';
import { hitXpRoute, killXpRoute } from './styles.js?v=546';
import { applyGoldFind } from './pacing.js?v=546';
...
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments,
         retreatAtFall } from './away.js?v=546';
...
import { chooseFood, resolveAutoEat } from './auto-eat.js?v=546';
/* THE FORECAST's seeded dice (ruling item 7). A fixed seed, never a clock —
   see `forecastFight` at the foot of this file. */
import { createRng } from './rng.js?v=546';
import { NO_BONUS } from './botd.js?v=546';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=546';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=546';
