...
//   import { setupSync } from './net/sync.js?v=371';
//   setupSync({
...
import { on, snapshot } from './events.js?v=371';
...
import { resolveActiveSlot } from './accrue.js?v=371';
...
import { balanceState } from './balance.js?v=371';
