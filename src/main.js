...
import { SKILLS_DEF } from './data/skills.js?v=353';
import { MONSTERS } from './data/monsters.js?v=353';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=353';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=353';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=353';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=353';
import { COMPANIONS } from './data/companions.js?v=353';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=353';
...
import './net/events.js?v=353';
import './net/sync.js?v=353';
...
import './net/gold.js?v=353';
import './net/auth.js?v=353';
import './net/supabase-bootstrap.js?v=353';
...
import './net/build-watch.js?v=353';
...
import './config.js?v=353';
import './utils/dom.js?v=353';
import './utils/safe.js?v=353';
import './utils/profile.js?v=353';
import './utils/data-integrity.js?v=353';
import './utils/image-fallback.js?v=353';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=353';
import { setupCompanions } from './features/companions.js?v=353';
import { setupActivitiesGrid } from './features/activities-grid.js?v=353';
import { setupCharacterPage } from './features/character-page.js?v=353';
import { setupCombatRender } from './features/combat-render.js?v=353';
import { setupRecipeBook } from './features/recipe-book.js?v=353';
import { setupItemIndex } from './features/item-index.js?v=353';
