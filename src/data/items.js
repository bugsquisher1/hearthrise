...
import { GEAR_ITEMS } from './gear-tiers.js?v=473';
import { WAVE3_ITEMS } from './wave3-uniques.js?v=473';
import { SLOT_ITEMS } from './slot-ladders.js?v=473';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=473';
import { LIB2_ITEMS } from './library2-items.js?v=473';
import { STONECRAFT_ITEMS } from './stonecraft.js?v=473';
