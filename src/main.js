...
import { MONSTERS } from './data/monsters.js?v=185';
import { ITEMS } from './data/items.js?v=185';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=185';
import { ARTISAN_RECIPES } from './data/recipes.js?v=185';
import { COMPANIONS } from './data/companions.js?v=185';
...
import './net/events.js?v=185';
import './net/sync.js?v=185';
import './net/auth.js?v=185';
import './net/supabase-bootstrap.js?v=185';
...
import './config.js?v=185';
import './utils/dom.js?v=185';
import './utils/safe.js?v=185';
import './utils/profile.js?v=185';
import './utils/data-integrity.js?v=185';
import './utils/image-fallback.js?v=185';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=185';
import { setupCompanions } from './features/companions.js?v=185';
import { setupActivitiesGrid } from './features/activities-grid.js?v=185';
import { setupCharacterPage } from './features/character-page.js?v=185';
import { setupCombatRender } from './features/combat-render.js?v=185';
