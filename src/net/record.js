...
import { applyClientState } from './client-state.js?v=545';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=545';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=545';
