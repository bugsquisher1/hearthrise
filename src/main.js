...
import { MONSTERS } from './data/monsters.js?v=235';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=235';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=235';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=235';
import { COMPANIONS } from './data/companions.js?v=235';
...
import './net/events.js?v=235';
import './net/sync.js?v=235';
import './net/auth.js?v=235';
import './net/supabase-bootstrap.js?v=235';
...
import './config.js?v=235';
import './utils/dom.js?v=235';
import './utils/safe.js?v=235';
import './utils/profile.js?v=235';
import './utils/data-integrity.js?v=235';
import './utils/image-fallback.js?v=235';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=235';
import { setupCompanions } from './features/companions.js?v=235';
import { setupActivitiesGrid } from './features/activities-grid.js?v=235';
import { setupCharacterPage } from './features/character-page.js?v=235';
import { setupCombatRender } from './features/combat-render.js?v=235';
