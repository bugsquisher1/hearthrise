...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=552';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=552';
import { actionIntervalMs } from './pacing.js?v=552';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=552';
import { sliceSpan } from './skill-sim.js?v=552';
