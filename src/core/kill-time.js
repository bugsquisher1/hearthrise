...
import { COMBAT_BALANCE } from './combat.js?v=500';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=500';
import { TOTAL_CAP } from './perks.js?v=500';
import { COMBAT_STYLES } from './styles.js?v=500';
import { ITEMS } from '../data/items.js?v=500';
