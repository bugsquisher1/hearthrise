...
import { SKILLS_DEF } from './data/skills.js?v=554';
import { MONSTERS } from './data/monsters.js?v=554';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=554';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=554';
import { MONSTER_NOTES } from './data/monster-notes.js?v=554';
import * as ItemArt from './data/item-art.js?v=554';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=554';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=554';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=554';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=554';
import { COMPANIONS } from './data/companions.js?v=554';
import { RAID_BOSSES } from './data/raid-bosses.js?v=554';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=554';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=554';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=554';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=554';
...
import './net/events.js?v=554';
import './net/sync.js?v=554';
...
import './net/dungeon-purchase.js?v=554';
...
import './net/predict.js?v=554';
import './net/record.js?v=554';
...
import './net/skill-record.js?v=554';
...
import './net/marks-record.js?v=554';
...
import './net/rooms-record.js?v=554';
...
import './net/property-record.js?v=554';
...
import './net/rested-record.js?v=554';
...
import './net/equipment-record.js?v=554';
...
import './net/trophy-claim.js?v=554';
...
import './net/dungeon-scrip-record.js?v=554';
import './net/dungeon-settle.js?v=554';
...
import './net/market-history.js?v=554';
import './net/auth.js?v=554';
import './net/supabase-bootstrap.js?v=554';
...
import './features/boot-hydration.js?v=554';
...
import './features/gem-unlocks.js?v=554';
import './features/recipe-scrolls.js?v=554';
...
import './render/house-themes.js?v=554';
...
import './net/build-watch.js?v=554';
...
import './config.js?v=554';
import './utils/dom.js?v=554';
import './utils/safe.js?v=554';
import './utils/profile.js?v=554';
import './utils/data-integrity.js?v=554';
import './utils/image-fallback.js?v=554';
...
import { setupBountyProgress } from './render/bounty-progress.js?v=554';
...
import { setupBestiaryCharms } from './render/bestiary-charms.js?v=554';
...
import { setupBestiaryTrophies } from './render/bestiary-trophies.js?v=554';
...
import { startTownChannel } from './net/town.js?v=554';
import { setupTownPanel } from './render/town-panel.js?v=554';
...
import './net/bank-sync.js?v=554';
import { setupBankPanel } from './render/bank-panel.js?v=554';
/* b535 - THE SUITE IS NOT PART OF THE GAME. This line used to pull
   ...
   when the harness flag or the player's own Ctrl+Shift+T / TEST control asks for
   it. Guard: tests/boot-budget.mjs. */
import { setupSmokeTestLoader } from './features/smoke-test-loader.js?v=554';
import { setupCompanions } from './features/companions.js?v=554';
import { setupActivitiesGrid } from './features/activities-grid.js?v=554';
import { setupCharacterPage } from './features/character-page.js?v=554';
import { setupCombatRender } from './features/combat-render.js?v=554';
import { setupCombatScreens } from './features/combat-screens.js?v=554';
import { setupRecipeBook } from './features/recipe-book.js?v=554';
import { setupItemIndex } from './features/item-index.js?v=554';
