...
import { applyClientState } from './client-state.js?v=547';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=547';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=547';
