...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots, reconcileHp } from './accrue.js?v=511';
...
import { applyClientState } from './client-state.js?v=511';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=511';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=511';
