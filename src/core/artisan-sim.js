...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=416';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=416';
import { actionIntervalMs } from './pacing.js?v=416';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=416';
import { sliceSpan } from './skill-sim.js?v=416';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=416';
import { levelOf } from './xp.js?v=416';
