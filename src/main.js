...
import { SKILLS_DEF } from './data/skills.js?v=151';
import { MONSTERS } from './data/monsters.js?v=151';
import { ITEMS } from './data/items.js?v=151';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=151';
import { ARTISAN_RECIPES } from './data/recipes.js?v=151';
import { COMPANIONS } from './data/companions.js?v=151';
...
import './net/events.js?v=151';
import './net/sync.js?v=151';
import './net/auth.js?v=151';
import './net/supabase-bootstrap.js?v=151';
...
import './config.js?v=151';
import './utils/dom.js?v=151';
import './utils/safe.js?v=151';
import './utils/profile.js?v=151';
import './utils/data-integrity.js?v=151';
import './utils/image-fallback.js?v=151';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=151';
import { setupCompanions } from './features/companions.js?v=151';
import { setupActivitiesGrid } from './features/activities-grid.js?v=151';
import { setupCharacterPage } from './features/character-page.js?v=151';
import { setupCombatRender } from './features/combat-render.js?v=151';
