...
//   import { setupSync } from './net/sync.js?v=506';
//   setupSync({
...
import { on, snapshot } from './events.js?v=506';
...
import { resolveActiveSlot } from './accrue.js?v=506';
...
import { balanceState } from './balance.js?v=506';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=506';
import { putClientState } from './client-state.js?v=506';
