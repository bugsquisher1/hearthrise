...
import { isElement, elementMultFor, MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=555';
...
import { charmDropMultFor, charmRankFor } from './charms.js?v=555';
