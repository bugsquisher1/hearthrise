...
import { levelFromXp } from './xp.js?v=482';
import { pacedXp } from './pacing.js?v=482';
import { spendRestedCharge } from './rested.js?v=482';
import { advanceToolCarry } from './tools.js?v=482';
