...
//   import { setupSync } from './net/sync.js?v=446';
//   setupSync({
...
import { on, snapshot } from './events.js?v=446';
...
import { resolveActiveSlot } from './accrue.js?v=446';
...
import { balanceState } from './balance.js?v=446';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=446';
import { putClientState } from './client-state.js?v=446';
