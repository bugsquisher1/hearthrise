...
import { levelFromXp } from './xp.js?v=532';
import { pacedXp } from './pacing.js?v=532';
import { spendRestedCharge } from './rested.js?v=532';
import { advanceToolCarry } from './tools.js?v=532';
