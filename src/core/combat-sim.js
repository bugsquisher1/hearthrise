...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=513';
import { rollDropTable } from './drops.js?v=513';
import { hitXpRoute, killXpRoute } from './styles.js?v=513';
import { applyGoldFind } from './pacing.js?v=513';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments } from './away.js?v=513';
import { NO_BONUS } from './botd.js?v=513';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=513';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=513';
