...
import { levelFromXp } from './xp.js?v=521';
import { pacedXp } from './pacing.js?v=521';
import { spendRestedCharge } from './rested.js?v=521';
import { advanceToolCarry } from './tools.js?v=521';
