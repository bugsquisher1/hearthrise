...
//   import { setupSync } from './net/sync.js?v=453';
//   setupSync({
...
import { on, snapshot } from './events.js?v=453';
...
import { resolveActiveSlot } from './accrue.js?v=453';
...
import { balanceState } from './balance.js?v=453';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=453';
import { putClientState } from './client-state.js?v=453';
