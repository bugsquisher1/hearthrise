...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=491';
import { ITEM_DESC } from '../data/item-descriptions.js?v=491';
import { SHOP_OFFERS } from '../data/shops.js?v=491';
