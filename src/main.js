...
import { MONSTERS } from './data/monsters.js?v=333';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=333';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=333';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=333';
import { COMPANIONS } from './data/companions.js?v=333';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=333';
...
import './net/events.js?v=333';
import './net/sync.js?v=333';
import './net/auth.js?v=333';
import './net/supabase-bootstrap.js?v=333';
...
import './net/build-watch.js?v=333';
...
import './config.js?v=333';
import './utils/dom.js?v=333';
import './utils/safe.js?v=333';
import './utils/profile.js?v=333';
import './utils/data-integrity.js?v=333';
import './utils/image-fallback.js?v=333';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=333';
import { setupCompanions } from './features/companions.js?v=333';
import { setupActivitiesGrid } from './features/activities-grid.js?v=333';
import { setupCharacterPage } from './features/character-page.js?v=333';
import { setupCombatRender } from './features/combat-render.js?v=333';
import { setupRecipeBook } from './features/recipe-book.js?v=333';
import { setupItemIndex } from './features/item-index.js?v=333';
