...
// modularised, will import { G } from '../state/game.js?v=222' directly.
//
// Triggered by:
...
import { on, snapshot } from '../net/events.js?v=222';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=222';
