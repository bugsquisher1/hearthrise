...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots, reconcileHp } from './accrue.js?v=512';
...
import { applyClientState } from './client-state.js?v=512';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=512';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=512';
