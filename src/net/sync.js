...
//   import { setupSync } from './net/sync.js?v=515';
//   setupSync({
...
import { on, snapshot } from './events.js?v=515';
...
import { resolveActiveSlot } from './accrue.js?v=515';
...
import { balanceState } from './balance.js?v=515';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=515';
import { putClientState } from './client-state.js?v=515';
