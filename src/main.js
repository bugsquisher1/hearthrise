...
import './net/events.js?v=356';
import './net/sync.js?v=356';
...
import './net/gold.js?v=356';
import './net/auth.js?v=356';
import './net/supabase-bootstrap.js?v=356';
...
import './net/build-watch.js?v=356';
...
import './config.js?v=356';
import './utils/dom.js?v=356';
import './utils/safe.js?v=356';
import './utils/profile.js?v=356';
import './utils/data-integrity.js?v=356';
import './utils/image-fallback.js?v=356';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=356';
import { setupCompanions } from './features/companions.js?v=356';
import { setupActivitiesGrid } from './features/activities-grid.js?v=356';
import { setupCharacterPage } from './features/character-page.js?v=356';
import { setupCombatRender } from './features/combat-render.js?v=356';
import { setupRecipeBook } from './features/recipe-book.js?v=356';
import { setupItemIndex } from './features/item-index.js?v=356';
