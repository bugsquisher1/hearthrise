...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=424';
import { rollDropTable } from './drops.js?v=424';
import { hitXpRoute, killXpRoute } from './styles.js?v=424';
import { applyGoldFind } from './pacing.js?v=424';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, utcDaySegments } from './away.js?v=424';
import { NO_BONUS } from './botd.js?v=424';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=424';
