...
import { SKILLS_DEF } from './skills.js?v=483';
import { COMBAT_STYLES } from '../core/styles.js?v=483';
import { GATHER_SKILLS } from '../core/pacing.js?v=483';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=483';
