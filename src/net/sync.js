...
//   import { setupSync } from './net/sync.js?v=466';
//   setupSync({
...
import { on, snapshot } from './events.js?v=466';
...
import { resolveActiveSlot } from './accrue.js?v=466';
...
import { balanceState } from './balance.js?v=466';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=466';
import { putClientState } from './client-state.js?v=466';
