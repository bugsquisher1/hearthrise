...
//   import { setupSync } from './net/sync.js?v=499';
//   setupSync({
...
import { on, snapshot } from './events.js?v=499';
...
import { resolveActiveSlot } from './accrue.js?v=499';
...
import { balanceState } from './balance.js?v=499';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=499';
import { putClientState } from './client-state.js?v=499';
