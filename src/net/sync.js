...
//   import { setupSync } from './net/sync.js?v=377';
//   setupSync({
...
import { on, snapshot } from './events.js?v=377';
...
import { resolveActiveSlot } from './accrue.js?v=377';
...
import { balanceState } from './balance.js?v=377';
