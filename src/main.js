...
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=362';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=362';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=362';
import { COMPANIONS } from './data/companions.js?v=362';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=362';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=362';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=362';
...
import './net/events.js?v=362';
import './net/sync.js?v=362';
...
import './net/market-history.js?v=362';
import './net/auth.js?v=362';
import './net/supabase-bootstrap.js?v=362';
...
import './net/build-watch.js?v=362';
...
import './config.js?v=362';
import './utils/dom.js?v=362';
import './utils/safe.js?v=362';
import './utils/profile.js?v=362';
import './utils/data-integrity.js?v=362';
import './utils/image-fallback.js?v=362';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=362';
import { setupCompanions } from './features/companions.js?v=362';
