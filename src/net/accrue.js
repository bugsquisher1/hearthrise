...
import * as itemLedger from './item-ledger.js?v=541';
...
import { serverOwnedItem, serverConsumedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=541';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=541';
...
import * as pendingConsume from './pending-consume.js?v=541';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=541';
...
import { notePropertyUnlocks, pickBankRung, isCompleteProgressStatement } from './property-record.js?v=541';
...
import { companionLevelFromXp } from '../core/companion-perk.js?v=541';
