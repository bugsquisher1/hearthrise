...
//   import { setupSync } from './net/sync.js?v=554';
//   setupSync({
...
import { on, snapshot } from './events.js?v=554';
...
import { resolveActiveSlot } from './accrue.js?v=554';
...
import { buildLoadRequest, classifyLoadResponse } from './record.js?v=554';
/* ── THE CAPSTONE SAVE PATH (blob-retire — the ONLY path since b515) ─────────
   ...
   sync.js. */
import { buildResiduePatch } from './capstone.js?v=554';
import { putClientState, isClientStateFromServer } from './client-state.js?v=554';
