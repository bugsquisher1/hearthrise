...
/* Appended to the SHARED chain (tests/pglite-chain.mjs), which already applies
   ...
   dependency:
     ...
     tool-carry          replaces hr_apply too and must be LAST of anything that
                         does — the new migration's §0 asserts exactly this and
                         refuses to install onto an older body
