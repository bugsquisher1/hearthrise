...
//   import { setupSync } from './net/sync.js?v=436';
//   setupSync({
...
import { on, snapshot } from './events.js?v=436';
...
import { resolveActiveSlot } from './accrue.js?v=436';
...
import { balanceState } from './balance.js?v=436';
