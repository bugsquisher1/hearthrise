...
import { SKILLS_DEF } from './skills.js?v=437';
import { COMBAT_STYLES } from '../core/styles.js?v=437';
import { GATHER_SKILLS } from '../core/pacing.js?v=437';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=437';
