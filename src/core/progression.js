...
import { levelFromXp } from './xp.js?v=518';
import { pacedXp } from './pacing.js?v=518';
import { spendRestedCharge } from './rested.js?v=518';
import { advanceToolCarry } from './tools.js?v=518';
