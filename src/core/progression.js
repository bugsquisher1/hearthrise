...
import { levelFromXp } from './xp.js?v=487';
import { pacedXp } from './pacing.js?v=487';
import { spendRestedCharge } from './rested.js?v=487';
import { advanceToolCarry } from './tools.js?v=487';
