...
import { SKILLS_DEF } from './data/skills.js?v=323';
import { MONSTERS } from './data/monsters.js?v=323';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=323';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=323';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=323';
import { COMPANIONS } from './data/companions.js?v=323';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=323';
...
import './net/events.js?v=323';
import './net/sync.js?v=323';
import './net/auth.js?v=323';
import './net/supabase-bootstrap.js?v=323';
...
import './config.js?v=323';
import './utils/dom.js?v=323';
import './utils/safe.js?v=323';
import './utils/profile.js?v=323';
import './utils/data-integrity.js?v=323';
import './utils/image-fallback.js?v=323';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=323';
import { setupCompanions } from './features/companions.js?v=323';
import { setupActivitiesGrid } from './features/activities-grid.js?v=323';
import { setupCharacterPage } from './features/character-page.js?v=323';
import { setupCombatRender } from './features/combat-render.js?v=323';
import { setupRecipeBook } from './features/recipe-book.js?v=323';
import { setupItemIndex } from './features/item-index.js?v=323';
