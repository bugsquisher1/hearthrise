...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm } from './accrue.js?v=459';
...
import { applyClientState } from './client-state.js?v=459';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=459';
