...
import * as rngMod from './core/rng.js?v=479';
import * as xp from './core/xp.js?v=479';
import * as combat from './core/combat.js?v=479';
import * as bane from './core/bane.js?v=479';
import * as elements from './core/elements.js?v=479';
import * as drops from './core/drops.js?v=479';
import * as pacing from './core/pacing.js?v=479';
import * as rested from './core/rested.js?v=479';
import * as tools from './core/tools.js?v=479';
import * as farm from './core/farm.js?v=479';
import * as progression from './core/progression.js?v=479';
import * as styles from './core/styles.js?v=479';
import * as artisan from './core/artisan.js?v=479';
import * as bounty from './core/bounty.js?v=479';
import * as away from './core/away.js?v=479';
import * as botd from './core/botd.js?v=479';
import * as buffs from './core/buffs.js?v=479';
import * as combatSim from './core/combat-sim.js?v=479';
...
import * as skillSim from './core/skill-sim.js?v=479';
...
import * as artisanSim from './core/artisan-sim.js?v=479';
...
import * as ammo from './core/ammo.js?v=479';
...
import * as autoEat from './core/auto-eat.js?v=479';
/* The PERMANENT PERK CHANNEL, shared with the server accrual engine. Layer 0
   ...
   implementation waiting to happen. */
import * as perks from './core/perks.js?v=479';
...
import * as goalCatalogue from './data/goal-catalogue.js?v=479';
