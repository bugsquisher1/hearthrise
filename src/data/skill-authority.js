...
import { SKILLS_DEF } from './skills.js?v=489';
import { COMBAT_STYLES } from '../core/styles.js?v=489';
import { GATHER_SKILLS } from '../core/pacing.js?v=489';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=489';
