...
//   import { setupSync } from './net/sync.js?v=418';
//   setupSync({
...
import { on, snapshot } from './events.js?v=418';
...
import { resolveActiveSlot } from './accrue.js?v=418';
...
import { balanceState } from './balance.js?v=418';
