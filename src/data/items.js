...
import { GEAR_ITEMS } from './gear-tiers.js?v=536';
import { WAVE3_ITEMS } from './wave3-uniques.js?v=536';
import { SLOT_ITEMS } from './slot-ladders.js?v=536';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=536';
import { LIB2_ITEMS } from './library2-items.js?v=536';
import { STONECRAFT_ITEMS } from './stonecraft.js?v=536';
