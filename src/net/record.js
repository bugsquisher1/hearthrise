...
import { applyClientState } from './client-state.js?v=541';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=541';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=541';
