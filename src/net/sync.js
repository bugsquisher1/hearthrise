...
//   import { setupSync } from './net/sync.js?v=443';
//   setupSync({
...
import { on, snapshot } from './events.js?v=443';
...
import { resolveActiveSlot } from './accrue.js?v=443';
...
import { balanceState } from './balance.js?v=443';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=443';
import { putClientState } from './client-state.js?v=443';
