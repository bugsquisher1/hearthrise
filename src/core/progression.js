...
import { levelFromXp } from './xp.js?v=472';
import { pacedXp } from './pacing.js?v=472';
import { spendRestedCharge } from './rested.js?v=472';
import { advanceToolCarry } from './tools.js?v=472';
