...
//   import { setupSync } from './net/sync.js?v=501';
//   setupSync({
...
import { on, snapshot } from './events.js?v=501';
...
import { resolveActiveSlot } from './accrue.js?v=501';
...
import { balanceState } from './balance.js?v=501';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=501';
import { putClientState } from './client-state.js?v=501';
