...
import { levelFromXp } from './xp.js?v=499';
import { pacedXp } from './pacing.js?v=499';
import { spendRestedCharge } from './rested.js?v=499';
import { advanceToolCarry } from './tools.js?v=499';
