...
import { GEAR_ITEMS } from './gear-tiers.js?v=412';
import { WAVE3_ITEMS } from './wave3-uniques.js?v=412';
import { SLOT_ITEMS } from './slot-ladders.js?v=412';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=412';
import { LIB2_ITEMS } from './library2-items.js?v=412';
import { STONECRAFT_ITEMS } from './stonecraft.js?v=412';
