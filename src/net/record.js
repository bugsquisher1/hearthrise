...
import { applyClientState } from './client-state.js?v=513';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=513';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=513';
