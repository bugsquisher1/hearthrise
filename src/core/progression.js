...
import { levelFromXp } from './xp.js?v=488';
import { pacedXp } from './pacing.js?v=488';
import { spendRestedCharge } from './rested.js?v=488';
import { advanceToolCarry } from './tools.js?v=488';
