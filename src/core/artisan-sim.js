...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=526';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=526';
import { actionIntervalMs } from './pacing.js?v=526';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=526';
import { sliceSpan } from './skill-sim.js?v=526';
