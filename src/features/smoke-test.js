...
// modularised, will import { G } from '../state/game.js?v=219' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=219';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=219';
