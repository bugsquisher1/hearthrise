...
//   import { setupSync } from './net/sync.js?v=532';
//   setupSync({
...
import { on, snapshot } from './events.js?v=532';
...
import { resolveActiveSlot } from './accrue.js?v=532';
...
import { buildLoadRequest, classifyLoadResponse } from './record.js?v=532';
/* ── THE CAPSTONE SAVE PATH (blob-retire — the ONLY path since b515) ─────────
   ...
   sync.js. */
import { buildResiduePatch } from './capstone.js?v=532';
import { putClientState, isClientStateFromServer } from './client-state.js?v=532';
