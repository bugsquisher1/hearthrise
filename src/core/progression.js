...
import { levelFromXp } from './xp.js?v=533';
import { pacedXp } from './pacing.js?v=533';
import { spendRestedCharge } from './rested.js?v=533';
import { advanceToolCarry } from './tools.js?v=533';
