...
//   import { setupSync } from './net/sync.js?v=513';
//   setupSync({
...
import { on, snapshot } from './events.js?v=513';
...
import { resolveActiveSlot } from './accrue.js?v=513';
...
import { balanceState } from './balance.js?v=513';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=513';
import { putClientState } from './client-state.js?v=513';
