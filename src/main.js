...
import { SKILLS_DEF } from './data/skills.js?v=242';
import { MONSTERS } from './data/monsters.js?v=242';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=242';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=242';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=242';
import { COMPANIONS } from './data/companions.js?v=242';
...
import './net/events.js?v=242';
import './net/sync.js?v=242';
import './net/auth.js?v=242';
import './net/supabase-bootstrap.js?v=242';
...
import './config.js?v=242';
import './utils/dom.js?v=242';
import './utils/safe.js?v=242';
import './utils/profile.js?v=242';
import './utils/data-integrity.js?v=242';
import './utils/image-fallback.js?v=242';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=242';
import { setupCompanions } from './features/companions.js?v=242';
import { setupActivitiesGrid } from './features/activities-grid.js?v=242';
import { setupCharacterPage } from './features/character-page.js?v=242';
import { setupCombatRender } from './features/combat-render.js?v=242';
import { setupRecipeBook } from './features/recipe-book.js?v=242';
import { setupItemIndex } from './features/item-index.js?v=242';
