...
//   import { setupSync } from './net/sync.js?v=470';
//   setupSync({
...
import { on, snapshot } from './events.js?v=470';
...
import { resolveActiveSlot } from './accrue.js?v=470';
...
import { balanceState } from './balance.js?v=470';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=470';
import { putClientState } from './client-state.js?v=470';
