...
import { resolveGatherAction } from './progression.js?v=527';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=527';
import { actionIntervalMs, MIN_ACTION_MS, GATHER_SKILLS } from './pacing.js?v=527';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=527';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=527';
import { levelOf } from './xp.js?v=527';
