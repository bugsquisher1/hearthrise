...
import { levelFromXp } from './xp.js?v=542';
import { pacedXp } from './pacing.js?v=542';
import { spendRestedCharge } from './rested.js?v=542';
import { advanceToolCarry } from './tools.js?v=542';
