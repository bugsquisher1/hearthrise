...
//   import { setupSync } from './net/sync.js?v=364';
//   setupSync({
...
import { on, snapshot } from './events.js?v=364';
...
import { resolveActiveSlot } from './accrue.js?v=364';
...
import { balanceState } from './balance.js?v=364';
