...
//   import { setupSync } from './net/sync.js?v=482';
//   setupSync({
...
import { on, snapshot } from './events.js?v=482';
...
import { resolveActiveSlot } from './accrue.js?v=482';
...
import { balanceState } from './balance.js?v=482';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=482';
import { putClientState } from './client-state.js?v=482';
