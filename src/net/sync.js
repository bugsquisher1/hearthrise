...
//   import { setupSync } from './net/sync.js?v=356';
//   setupSync({
...
import { on, snapshot } from './events.js?v=356';
...
import { resolveActiveSlot } from './accrue.js?v=356';
...
import { balanceState } from './balance.js?v=356';
