...
//   import { setupSync } from './net/sync.js?v=412';
//   setupSync({
...
import { on, snapshot } from './events.js?v=412';
...
import { resolveActiveSlot } from './accrue.js?v=412';
...
import { balanceState } from './balance.js?v=412';
