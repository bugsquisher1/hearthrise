...
//   import { setupSync } from './net/sync.js?v=427';
//   setupSync({
...
import { on, snapshot } from './events.js?v=427';
...
import { resolveActiveSlot } from './accrue.js?v=427';
...
import { balanceState } from './balance.js?v=427';
