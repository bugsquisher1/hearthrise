...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=527';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=527';
import { actionIntervalMs } from './pacing.js?v=527';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=527';
import { sliceSpan } from './skill-sim.js?v=527';
