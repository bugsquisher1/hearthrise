...
//   import { setupSync } from './net/sync.js?v=489';
//   setupSync({
...
import { on, snapshot } from './events.js?v=489';
...
import { resolveActiveSlot } from './accrue.js?v=489';
...
import { balanceState } from './balance.js?v=489';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=489';
import { putClientState } from './client-state.js?v=489';
