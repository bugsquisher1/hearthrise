...
// modularised, will import { G } from '../state/game.js?v=153' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=153';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=153';
