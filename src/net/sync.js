...
//   import { setupSync } from './net/sync.js?v=542';
//   setupSync({
...
import { on, snapshot } from './events.js?v=542';
...
import { buildLoadRequest, classifyLoadResponse } from './record.js?v=542';
/* ── THE CAPSTONE SAVE PATH (blob-retire — the ONLY path since b515) ─────────
   ...
   sync.js. */
import { buildResiduePatch } from './capstone.js?v=542';
import { putClientState, isClientStateFromServer } from './client-state.js?v=542';
