...
import * as rngMod from './core/rng.js?v=397';
import * as xp from './core/xp.js?v=397';
import * as combat from './core/combat.js?v=397';
import * as bane from './core/bane.js?v=397';
import * as elements from './core/elements.js?v=397';
import * as drops from './core/drops.js?v=397';
import * as pacing from './core/pacing.js?v=397';
import * as rested from './core/rested.js?v=397';
import * as tools from './core/tools.js?v=397';
import * as farm from './core/farm.js?v=397';
import * as progression from './core/progression.js?v=397';
import * as styles from './core/styles.js?v=397';
import * as artisan from './core/artisan.js?v=397';
import * as bounty from './core/bounty.js?v=397';
import * as away from './core/away.js?v=397';
import * as botd from './core/botd.js?v=397';
import * as buffs from './core/buffs.js?v=397';
import * as combatSim from './core/combat-sim.js?v=397';
...
import * as skillSim from './core/skill-sim.js?v=397';
...
import * as artisanSim from './core/artisan-sim.js?v=397';
...
import * as ammo from './core/ammo.js?v=397';
...
import * as autoEat from './core/auto-eat.js?v=397';
/* The PERMANENT PERK CHANNEL, shared with the server accrual engine. Layer 0
   ...
   implementation waiting to happen. */
import * as perks from './core/perks.js?v=397';
