...
import { SKILLS_DEF } from './skills.js?v=464';
import { COMBAT_STYLES } from '../core/styles.js?v=464';
import { GATHER_SKILLS } from '../core/pacing.js?v=464';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=464';
