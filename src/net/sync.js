...
//   import { setupSync } from './net/sync.js?v=451';
//   setupSync({
...
import { on, snapshot } from './events.js?v=451';
...
import { resolveActiveSlot } from './accrue.js?v=451';
...
import { balanceState } from './balance.js?v=451';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=451';
import { putClientState } from './client-state.js?v=451';
