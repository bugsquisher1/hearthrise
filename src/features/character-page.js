...
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS } from '../data/gathering.js?v=353';
import { ARTISAN_RECIPES } from '../data/recipes.js?v=353';
...
import { balanceMarkup } from '../net/balance.js?v=353';
