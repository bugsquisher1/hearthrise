...
function injectCombatExtras(){
  ...
  if(dropsChip && /Drops:/.test(dropsChip.textContent)){
    ...
    list.innerHTML = '<div style="font-size:calc(14.5px * var(--ui-scale, 1));text-transform:uppercase;letter-spacing:.08em;color:var(--ink-3);font-weight:700;margin-bottom:4px">Drop Table</div>'+
      m.drops.map(function(d){
        ...
        var iconHtml = path ? '<img src="'+path+'" alt="" />' : '<span style="font-size:calc(16px * var(--ui-scale, 1))">'+(def?.icon||'?')+'</span>';
