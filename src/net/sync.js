...
//   import { setupSync } from './net/sync.js?v=396';
//   setupSync({
...
import { on, snapshot } from './events.js?v=396';
...
import { resolveActiveSlot } from './accrue.js?v=396';
...
import { balanceState } from './balance.js?v=396';
