...
//   import { setupSync } from './net/sync.js?v=481';
//   setupSync({
...
import { on, snapshot } from './events.js?v=481';
...
import { resolveActiveSlot } from './accrue.js?v=481';
...
import { balanceState } from './balance.js?v=481';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=481';
import { putClientState } from './client-state.js?v=481';
