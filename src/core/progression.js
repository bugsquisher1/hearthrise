...
import { levelFromXp } from './xp.js?v=527';
import { pacedXp } from './pacing.js?v=527';
import { spendRestedCharge } from './rested.js?v=527';
import { advanceToolCarry } from './tools.js?v=527';
