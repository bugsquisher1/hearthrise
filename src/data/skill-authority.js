...
import { SKILLS_DEF } from './skills.js?v=519';
import { COMBAT_STYLES } from '../core/styles.js?v=519';
import { GATHER_SKILLS } from '../core/pacing.js?v=519';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=519';
