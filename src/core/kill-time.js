...
import { COMBAT_BALANCE } from './combat.js?v=545';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=545';
import { TOTAL_CAP } from './perks.js?v=545';
import { COMBAT_STYLES } from './styles.js?v=545';
