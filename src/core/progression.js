...
import { levelFromXp } from './xp.js?v=523';
import { pacedXp } from './pacing.js?v=523';
import { spendRestedCharge } from './rested.js?v=523';
import { advanceToolCarry } from './tools.js?v=523';
