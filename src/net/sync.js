...
//   import { setupSync } from './net/sync.js?v=449';
//   setupSync({
...
import { on, snapshot } from './events.js?v=449';
...
import { resolveActiveSlot } from './accrue.js?v=449';
...
import { balanceState } from './balance.js?v=449';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=449';
import { putClientState } from './client-state.js?v=449';
