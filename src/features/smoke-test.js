...
// modularised, will import { G } from '../state/game.js?v=158' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=158';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=158';
