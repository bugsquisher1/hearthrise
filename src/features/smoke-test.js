...
// modularised, will import { G } from '../state/game.js?v=211' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=211';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=211';
