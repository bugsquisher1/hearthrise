...
//   import { setupSync } from './net/sync.js?v=406';
//   setupSync({
...
import { on, snapshot } from './events.js?v=406';
...
import { resolveActiveSlot } from './accrue.js?v=406';
...
import { balanceState } from './balance.js?v=406';
