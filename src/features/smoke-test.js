...
// modularised, will import { G } from '../state/game.js?v=159' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=159';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=159';
