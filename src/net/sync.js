...
//   import { setupSync } from './net/sync.js?v=413';
//   setupSync({
...
import { on, snapshot } from './events.js?v=413';
...
import { resolveActiveSlot } from './accrue.js?v=413';
...
import { balanceState } from './balance.js?v=413';
