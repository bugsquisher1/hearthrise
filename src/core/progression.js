...
import { levelFromXp } from './xp.js?v=484';
import { pacedXp } from './pacing.js?v=484';
import { spendRestedCharge } from './rested.js?v=484';
import { advanceToolCarry } from './tools.js?v=484';
