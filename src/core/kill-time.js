...
import { COMBAT_BALANCE } from './combat.js?v=515';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=515';
import { TOTAL_CAP } from './perks.js?v=515';
import { COMBAT_STYLES } from './styles.js?v=515';
import { ITEMS } from '../data/items.js?v=515';
