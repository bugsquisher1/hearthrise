...
//   import { setupSync } from './net/sync.js?v=485';
//   setupSync({
...
import { on, snapshot } from './events.js?v=485';
...
import { resolveActiveSlot } from './accrue.js?v=485';
...
import { balanceState } from './balance.js?v=485';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=485';
import { putClientState } from './client-state.js?v=485';
