...
//   import { setupSync } from './net/sync.js?v=393';
//   setupSync({
...
import { on, snapshot } from './events.js?v=393';
...
import { resolveActiveSlot } from './accrue.js?v=393';
...
import { balanceState } from './balance.js?v=393';
