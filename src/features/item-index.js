...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=411';
import { ITEM_DESC } from '../data/item-descriptions.js?v=411';
import { SHOP_OFFERS } from '../data/shops.js?v=411';
