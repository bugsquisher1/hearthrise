...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=494';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=494';
import { actionIntervalMs } from './pacing.js?v=494';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=494';
import { sliceSpan } from './skill-sim.js?v=494';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=494';
import { levelOf } from './xp.js?v=494';
