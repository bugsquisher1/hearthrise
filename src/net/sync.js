...
//   import { setupSync } from './net/sync.js?v=487';
//   setupSync({
...
import { on, snapshot } from './events.js?v=487';
...
import { resolveActiveSlot } from './accrue.js?v=487';
...
import { balanceState } from './balance.js?v=487';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=487';
import { putClientState } from './client-state.js?v=487';
