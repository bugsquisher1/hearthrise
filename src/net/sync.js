...
//   import { setupSync } from './net/sync.js?v=467';
//   setupSync({
...
import { on, snapshot } from './events.js?v=467';
...
import { resolveActiveSlot } from './accrue.js?v=467';
...
import { balanceState } from './balance.js?v=467';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=467';
import { putClientState } from './client-state.js?v=467';
