...
import { SKILLS_DEF } from './data/skills.js?v=405';
import { MONSTERS } from './data/monsters.js?v=405';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=405';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=405';
import * as ItemArt from './data/item-art.js?v=405';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=405';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=405';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=405';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=405';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=405';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=405';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=405';
...
import './net/events.js?v=405';
import './net/sync.js?v=405';
...
import './net/dungeon-purchase.js?v=405';
...
import './net/market-history.js?v=405';
import './net/auth.js?v=405';
import './net/supabase-bootstrap.js?v=405';
...
import './net/build-watch.js?v=405';
...
import './config.js?v=405';
import './utils/dom.js?v=405';
import './utils/safe.js?v=405';
import './utils/profile.js?v=405';
import './utils/data-integrity.js?v=405';
import './utils/image-fallback.js?v=405';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=405';
import { setupCompanions } from './features/companions.js?v=405';
import { setupActivitiesGrid } from './features/activities-grid.js?v=405';
import { setupCharacterPage } from './features/character-page.js?v=405';
import { setupCombatRender } from './features/combat-render.js?v=405';
import { setupCombatScreens } from './features/combat-screens.js?v=405';
import { setupRecipeBook } from './features/recipe-book.js?v=405';
import { setupItemIndex } from './features/item-index.js?v=405';
