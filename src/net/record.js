...
import { applyClientState } from './client-state.js?v=544';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=544';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=544';
