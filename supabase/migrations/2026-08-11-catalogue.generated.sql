...
insert into public.hr_items (item_id, name, tradeable, kind, value, req_skill, req_lv, heals, auto_eatable) values
  ('abyssal_greaves','Abyssal Greaves',true,'armor',198000,'defense',88,null,false),
  ...
  ('apprentice_staff','Apprentice Staff',true,'weapon',80,'magic',1,null,false),
  ...
  ('bronze_sword','Bronze Sword',true,'weapon',50,'attack',1,null,false),
  ...
  ('copper_crab','Copper Crab',true,null,37,null,null,9,true),
  ...
  ('goldgill','Raw Goldgill',true,null,71,null,null,11,true),
  ...
  ('heartwood_cape','Heartwood Cape',true,'armor',11700,'defense',75,null,false),
  ...
  ('leather_boots','Leather Boots',true,'armor',90,'defense',1,null,false),
  ('leather_gloves','Leather Gloves',true,'armor',80,'defense',1,null,false),
  ...
  ('longbow','Longbow',true,'weapon',400,'ranged',15,null,false),
  ...
  ('shortbow','Shortbow',true,'weapon',90,'ranged',1,null,false),
  ('shrimp','Raw Shrimp',true,null,5,null,null,3,true),
  ('silk_thread','Silk Thread',true,null,55,null,null,null,false),
  ('silverfin','Raw Silverfin',true,null,51,null,null,10,true),
  ('slagheart_core','Slagheart Core',true,null,3200,null,null,null,false),
  ('slagheart_platebody','Slagheart Platebody',true,'armor',270000,'defense',88,null,false),
  ...
  ('steel_platebody','Steel Platebody',true,'armor',1500,'defense',30,null,false),
  ...
  ('tally_ring','Tally Ring',true,'jewelry',180,'defense',1,null,false),
  ...
  ('warden_girdle','Warden''s Girdle',true,'armor',72000,'defense',88,null,false),
  ...
  ('wyrmgilt_mantle','Wyrmgilt Mantle',true,'armor',90000,'defense',88,null,false),
...
insert into public.hr_activities (kind, activity_id, req_skill, req_lv, max_hp, is_boss) values
  ...
  ('artisan','cook_copper_crab','cooking',21,null,false),
  ...
  ('artisan','cook_fishers_pie','cooking',56,null,false),
  ('artisan','cook_frostfin','cooking',70,null,false),
  ('artisan','cook_goldenroot','cooking',65,null,false),
  ('artisan','cook_goldgill','cooking',27,null,false),
  ...
  ('gather','pikeperch_s','fishing',24,null,false),
