...
//   import { setupSync } from './net/sync.js?v=486';
//   setupSync({
...
import { on, snapshot } from './events.js?v=486';
...
import { resolveActiveSlot } from './accrue.js?v=486';
...
import { balanceState } from './balance.js?v=486';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=486';
import { putClientState } from './client-state.js?v=486';
