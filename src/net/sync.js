...
//   import { setupSync } from './net/sync.js?v=503';
//   setupSync({
...
import { on, snapshot } from './events.js?v=503';
...
import { resolveActiveSlot } from './accrue.js?v=503';
...
import { balanceState } from './balance.js?v=503';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=503';
import { putClientState } from './client-state.js?v=503';
