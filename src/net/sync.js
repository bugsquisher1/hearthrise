...
//   import { setupSync } from './net/sync.js?v=374';
//   setupSync({
...
import { on, snapshot } from './events.js?v=374';
...
import { resolveActiveSlot } from './accrue.js?v=374';
...
import { balanceState } from './balance.js?v=374';
