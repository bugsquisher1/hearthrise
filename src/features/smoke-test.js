...
// modularised, will import { G } from '../state/game.js?v=155' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=155';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=155';
