...
//   import { setupSync } from './net/sync.js?v=428';
//   setupSync({
...
import { on, snapshot } from './events.js?v=428';
...
import { resolveActiveSlot } from './accrue.js?v=428';
...
import { balanceState } from './balance.js?v=428';
