...
import { resolveGatherAction } from './progression.js?v=346';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=346';
import { actionIntervalMs, MIN_ACTION_MS, GATHER_SKILLS } from './pacing.js?v=346';
import { rateMult } from './away.js?v=346';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=346';
import { levelOf } from './xp.js?v=346';
