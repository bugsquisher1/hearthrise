...
//   import { setupSync } from './net/sync.js?v=456';
//   setupSync({
...
import { on, snapshot } from './events.js?v=456';
...
import { resolveActiveSlot } from './accrue.js?v=456';
...
import { balanceState } from './balance.js?v=456';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=456';
import { putClientState } from './client-state.js?v=456';
