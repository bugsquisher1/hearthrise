...
import { SKILLS_DEF } from './data/skills.js?v=150';
import { MONSTERS } from './data/monsters.js?v=150';
import { ITEMS } from './data/items.js?v=150';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=150';
import { ARTISAN_RECIPES } from './data/recipes.js?v=150';
...
import './net/events.js?v=150';
import './net/sync.js?v=150';
import './net/auth.js?v=150';
import './net/supabase-bootstrap.js?v=150';
...
import './config.js?v=150';
import './utils/dom.js?v=150';
import './utils/safe.js?v=150';
import './utils/profile.js?v=150';
import './utils/data-integrity.js?v=150';
import './utils/image-fallback.js?v=150';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=150';
import { setupCompanions } from './features/companions.js?v=150';
import { setupActivitiesGrid } from './features/activities-grid.js?v=150';
import { setupCharacterPage } from './features/character-page.js?v=150';
import { setupCombatRender } from './features/combat-render.js?v=150';
