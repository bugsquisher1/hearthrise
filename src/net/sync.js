...
//   import { setupSync } from './net/sync.js?v=372';
//   setupSync({
...
import { on, snapshot } from './events.js?v=372';
...
import { resolveActiveSlot } from './accrue.js?v=372';
...
import { balanceState } from './balance.js?v=372';
