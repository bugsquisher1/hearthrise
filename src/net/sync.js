...
//   import { setupSync } from './net/sync.js?v=403';
//   setupSync({
...
import { on, snapshot } from './events.js?v=403';
...
import { resolveActiveSlot } from './accrue.js?v=403';
...
import { balanceState } from './balance.js?v=403';
