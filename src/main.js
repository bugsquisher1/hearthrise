...
import { SKILLS_DEF } from './data/skills.js?v=221';
...
import './net/events.js?v=221';
import './net/sync.js?v=221';
import './net/auth.js?v=221';
import './net/supabase-bootstrap.js?v=221';
...
import './config.js?v=221';
import './utils/dom.js?v=221';
import './utils/safe.js?v=221';
import './utils/profile.js?v=221';
import './utils/data-integrity.js?v=221';
import './utils/image-fallback.js?v=221';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=221';
import { setupCompanions } from './features/companions.js?v=221';
import { setupActivitiesGrid } from './features/activities-grid.js?v=221';
import { setupCharacterPage } from './features/character-page.js?v=221';
import { setupCombatRender } from './features/combat-render.js?v=221';
