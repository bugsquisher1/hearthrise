...
//   import { setupSync } from './net/sync.js?v=426';
//   setupSync({
...
import { on, snapshot } from './events.js?v=426';
...
import { resolveActiveSlot } from './accrue.js?v=426';
...
import { balanceState } from './balance.js?v=426';
