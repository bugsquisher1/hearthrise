...
//   import { setupSync } from './net/sync.js?v=373';
//   setupSync({
...
import { on, snapshot } from './events.js?v=373';
...
import { resolveActiveSlot } from './accrue.js?v=373';
...
import { balanceState } from './balance.js?v=373';
