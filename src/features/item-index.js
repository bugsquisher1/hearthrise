...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=532';
import { ITEM_DESC } from '../data/item-descriptions.js?v=532';
import { SHOP_OFFERS } from '../data/shops.js?v=532';
