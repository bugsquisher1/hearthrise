...
import * as itemLedger from './item-ledger.js?v=503';
...
import { serverOwnedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=503';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=503';
...
import * as pendingConsume from './pending-consume.js?v=503';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=503';
...
import { notePropertyUnlocks } from './property-record.js?v=503';
