...
//   import { setupSync } from './net/sync.js?v=447';
//   setupSync({
...
import { on, snapshot } from './events.js?v=447';
...
import { resolveActiveSlot } from './accrue.js?v=447';
...
import { balanceState } from './balance.js?v=447';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=447';
import { putClientState } from './client-state.js?v=447';
