...
//   import { setupSync } from './net/sync.js?v=473';
//   setupSync({
...
import { on, snapshot } from './events.js?v=473';
...
import { resolveActiveSlot } from './accrue.js?v=473';
...
import { balanceState } from './balance.js?v=473';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=473';
import { putClientState } from './client-state.js?v=473';
