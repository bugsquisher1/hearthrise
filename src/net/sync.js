...
//   import { setupSync } from './net/sync.js?v=520';
//   setupSync({
...
import { on, snapshot } from './events.js?v=520';
...
import { buildLoadRequest, classifyLoadResponse } from './record.js?v=520';
/* ── THE CAPSTONE SAVE PATH (blob-retire — the ONLY path since b515) ─────────
   ...
   sync.js. */
import { buildResiduePatch } from './capstone.js?v=520';
import { putClientState, isClientStateFromServer } from './client-state.js?v=520';
