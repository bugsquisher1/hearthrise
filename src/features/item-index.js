...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=511';
import { ITEM_DESC } from '../data/item-descriptions.js?v=511';
import { SHOP_OFFERS } from '../data/shops.js?v=511';
