...
//   import { setupSync } from './net/sync.js?v=462';
//   setupSync({
...
import { on, snapshot } from './events.js?v=462';
...
import { resolveActiveSlot } from './accrue.js?v=462';
...
import { balanceState } from './balance.js?v=462';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=462';
import { putClientState } from './client-state.js?v=462';
