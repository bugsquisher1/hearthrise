...
//   import { setupSync } from './net/sync.js?v=492';
//   setupSync({
...
import { on, snapshot } from './events.js?v=492';
...
import { resolveActiveSlot } from './accrue.js?v=492';
...
import { balanceState } from './balance.js?v=492';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=492';
import { putClientState } from './client-state.js?v=492';
