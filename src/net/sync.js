...
//   import { setupSync } from './net/sync.js?v=375';
//   setupSync({
...
import { on, snapshot } from './events.js?v=375';
...
import { resolveActiveSlot } from './accrue.js?v=375';
...
import { balanceState } from './balance.js?v=375';
