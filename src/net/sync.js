...
//   import { setupSync } from './net/sync.js?v=414';
//   setupSync({
...
import { on, snapshot } from './events.js?v=414';
...
import { resolveActiveSlot } from './accrue.js?v=414';
...
import { balanceState } from './balance.js?v=414';
