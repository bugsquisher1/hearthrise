...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=387';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=387';
import { ITEM_DESC } from '../data/item-descriptions.js?v=387';
import { SHOP_OFFERS } from '../data/shops.js?v=387';
