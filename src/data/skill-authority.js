...
import { SKILLS_DEF } from './skills.js?v=432';
import { COMBAT_STYLES } from '../core/styles.js?v=432';
import { GATHER_SKILLS } from '../core/pacing.js?v=432';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=432';
