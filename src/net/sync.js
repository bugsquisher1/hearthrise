...
//   import { setupSync } from './net/sync.js?v=395';
//   setupSync({
...
import { on, snapshot } from './events.js?v=395';
...
import { resolveActiveSlot } from './accrue.js?v=395';
...
import { balanceState } from './balance.js?v=395';
