...
import { levelFromXp } from './xp.js?v=374';
import { pacedXp } from './pacing.js?v=374';
import { spendRestedCharge } from './rested.js?v=374';
import { advanceToolCarry } from './tools.js?v=374';
