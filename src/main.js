...
import { MONSTERS } from './data/monsters.js?v=200';
import { ITEMS } from './data/items.js?v=200';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=200';
...
import './net/events.js?v=200';
import './net/sync.js?v=200';
import './net/auth.js?v=200';
import './net/supabase-bootstrap.js?v=200';
...
import './config.js?v=200';
import './utils/dom.js?v=200';
import './utils/safe.js?v=200';
import './utils/profile.js?v=200';
import './utils/data-integrity.js?v=200';
import './utils/image-fallback.js?v=200';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=200';
import { setupCompanions } from './features/companions.js?v=200';
import { setupActivitiesGrid } from './features/activities-grid.js?v=200';
import { setupCharacterPage } from './features/character-page.js?v=200';
import { setupCombatRender } from './features/combat-render.js?v=200';
