...
//   import { setupSync } from './net/sync.js?v=407';
//   setupSync({
...
import { on, snapshot } from './events.js?v=407';
...
import { resolveActiveSlot } from './accrue.js?v=407';
...
import { balanceState } from './balance.js?v=407';
