...
export const LINKS = [
  ...
  /* Link 10 (M7, the Bestiary trophy ladder) — TWO ENGINE ENTRIES, one read and
     ...
     declared-removals list. Its base is link 9's TARGET, the body production
     runs once the chain is applied in order, so nothing an earlier link
     recorded can be dropped here. */
  {
