...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      '  background:url(assets/brand/hearthrise-splash.jpg?v=432) 50% 42%/cover no-repeat}',
  ...
  var BRAND = {
    crest: 'assets/brand/hearthrise-crest.png?v=432',
    word:  'assets/brand/hearthrise-wordmark.svg?v=432'
  };
