...
//   import { setupSync } from './net/sync.js?v=491';
//   setupSync({
...
import { on, snapshot } from './events.js?v=491';
...
import { resolveActiveSlot } from './accrue.js?v=491';
...
import { balanceState } from './balance.js?v=491';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=491';
import { putClientState } from './client-state.js?v=491';
