...
//   import { setupSync } from './net/sync.js?v=416';
//   setupSync({
...
import { on, snapshot } from './events.js?v=416';
...
import { resolveActiveSlot } from './accrue.js?v=416';
...
import { balanceState } from './balance.js?v=416';
