...
import { MONSTERS } from './data/monsters.js?v=188';
import { ITEMS } from './data/items.js?v=188';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=188';
import { ARTISAN_RECIPES } from './data/recipes.js?v=188';
import { COMPANIONS } from './data/companions.js?v=188';
...
import './net/events.js?v=188';
import './net/sync.js?v=188';
import './net/auth.js?v=188';
import './net/supabase-bootstrap.js?v=188';
...
import './config.js?v=188';
import './utils/dom.js?v=188';
import './utils/safe.js?v=188';
import './utils/profile.js?v=188';
import './utils/data-integrity.js?v=188';
import './utils/image-fallback.js?v=188';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=188';
import { setupCompanions } from './features/companions.js?v=188';
import { setupActivitiesGrid } from './features/activities-grid.js?v=188';
import { setupCharacterPage } from './features/character-page.js?v=188';
import { setupCombatRender } from './features/combat-render.js?v=188';
