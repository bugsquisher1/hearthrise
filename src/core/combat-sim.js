...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=518';
import { rollDropTable } from './drops.js?v=518';
import { hitXpRoute, killXpRoute } from './styles.js?v=518';
import { applyGoldFind } from './pacing.js?v=518';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments } from './away.js?v=518';
import { NO_BONUS } from './botd.js?v=518';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=518';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=518';
