...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=540';
import { rollDropTable } from './drops.js?v=540';
import { resolveHearthfind } from './hearthfind.js?v=540';
import { hitXpRoute, killXpRoute } from './styles.js?v=540';
import { applyGoldFind } from './pacing.js?v=540';
...
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments,
         retreatAtFall } from './away.js?v=540';
...
import { chooseFood, resolveAutoEat } from './auto-eat.js?v=540';
/* THE FORECAST's seeded dice (ruling item 7). A fixed seed, never a clock —
   see `forecastFight` at the foot of this file. */
import { createRng } from './rng.js?v=540';
import { NO_BONUS } from './botd.js?v=540';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=540';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=540';
