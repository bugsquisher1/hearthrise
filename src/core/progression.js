...
import { levelFromXp } from './xp.js?v=524';
import { pacedXp } from './pacing.js?v=524';
import { spendRestedCharge } from './rested.js?v=524';
import { advanceToolCarry } from './tools.js?v=524';
