...
//   import { setupSync } from './net/sync.js?v=507';
//   setupSync({
...
import { on, snapshot } from './events.js?v=507';
...
import { resolveActiveSlot } from './accrue.js?v=507';
...
import { balanceState } from './balance.js?v=507';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=507';
import { putClientState } from './client-state.js?v=507';
