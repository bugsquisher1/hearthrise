...
import * as itemLedger from './item-ledger.js?v=418';
...
import { serverOwnedItem, rebuildItemAuthority } from '../data/item-authority.js?v=418';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=418';
