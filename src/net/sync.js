...
//   import { setupSync } from './net/sync.js?v=454';
//   setupSync({
...
import { on, snapshot } from './events.js?v=454';
...
import { resolveActiveSlot } from './accrue.js?v=454';
...
import { balanceState } from './balance.js?v=454';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=454';
import { putClientState } from './client-state.js?v=454';
