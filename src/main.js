...
import { SKILLS_DEF } from './data/skills.js?v=359';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=359';
import { COMPANIONS } from './data/companions.js?v=359';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=359';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=359';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=359';
...
import './net/events.js?v=359';
import './net/sync.js?v=359';
...
import './net/gold.js?v=359';
import './net/auth.js?v=359';
import './net/supabase-bootstrap.js?v=359';
...
import './net/build-watch.js?v=359';
...
import './config.js?v=359';
import './utils/dom.js?v=359';
import './utils/safe.js?v=359';
import './utils/profile.js?v=359';
import './utils/data-integrity.js?v=359';
import './utils/image-fallback.js?v=359';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=359';
import { setupCompanions } from './features/companions.js?v=359';
import { setupActivitiesGrid } from './features/activities-grid.js?v=359';
import { setupCharacterPage } from './features/character-page.js?v=359';
import { setupCombatRender } from './features/combat-render.js?v=359';
import { setupRecipeBook } from './features/recipe-book.js?v=359';
import { setupItemIndex } from './features/item-index.js?v=359';
