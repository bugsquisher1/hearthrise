...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=322';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=322';
import { ITEM_DESC } from '../data/item-descriptions.js?v=322';
