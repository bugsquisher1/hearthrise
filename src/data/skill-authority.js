...
import { SKILLS_DEF } from './skills.js?v=500';
import { COMBAT_STYLES } from '../core/styles.js?v=500';
import { GATHER_SKILLS } from '../core/pacing.js?v=500';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=500';
