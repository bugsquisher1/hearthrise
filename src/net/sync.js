...
//   import { setupSync } from './net/sync.js?v=502';
//   setupSync({
...
import { on, snapshot } from './events.js?v=502';
...
import { resolveActiveSlot } from './accrue.js?v=502';
...
import { balanceState } from './balance.js?v=502';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=502';
import { putClientState } from './client-state.js?v=502';
