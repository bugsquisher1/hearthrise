...
//   import { setupSync } from './net/sync.js?v=401';
//   setupSync({
...
import { on, snapshot } from './events.js?v=401';
...
import { resolveActiveSlot } from './accrue.js?v=401';
...
import { balanceState } from './balance.js?v=401';
