...
import { COMBAT_BALANCE } from './combat.js?v=546';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=546';
import { TOTAL_CAP } from './perks.js?v=546';
import { COMBAT_STYLES } from './styles.js?v=546';
