...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      '.hr-cl-eyebrow{font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:var(--ink-3,#a5896a)}',
      ...
      '.hr-cl-tab{flex:1;text-align:center;padding:8px;border-radius:9px 9px 0 0;border:1px solid transparent;cursor:pointer;font-weight:700;font-size:13px;color:var(--ink-3,#a5896a)}',
      ...
      '.hr-cl-nm{font-size:8px;color:var(--ink-3,#a5896a);line-height:1.05;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:100%}',
      '.hr-cl-sec{padding:2px 12px;font-size:11px;font-weight:700;color:var(--gold-2,#c8862a);text-transform:uppercase;letter-spacing:.08em}',
      ...
      '.hr-cl-msb{flex:1;font-size:12px}',
      '.hr-cl-claim{border:none;border-radius:8px;padding:7px 13px;font-weight:800;font-size:12px;cursor:pointer;background:linear-gradient(180deg,var(--gold,#f0b860),var(--gold-2,#d99c40));color:var(--bg-0,#20160a)}',
      '.hr-cl-detail{padding:14px}',
      '.hr-cl-stats{padding:2px 12px;font-size:12px;color:var(--ink-2,#cbb890);line-height:1.5}',
      '.hr-cl-drop{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:6px 9px;border-radius:7px;background:var(--bg-2,#2c2216);margin:4px 0;font-size:12px}',
      '.hr-cl-drop b{color:var(--gold,#e0a64a);font-variant-numeric:tabular-nums}',
      '.hr-cl-drop em{color:var(--ink-3,#a5896a);font-style:normal;font-size:11px}'
    ].join('');
