...
//   import { setupSync } from './net/sync.js?v=483';
//   setupSync({
...
import { on, snapshot } from './events.js?v=483';
...
import { resolveActiveSlot } from './accrue.js?v=483';
...
import { balanceState } from './balance.js?v=483';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=483';
import { putClientState } from './client-state.js?v=483';
