...
import { maxHitCeil, MIN_TICK_MS, PLAUSIBILITY_HEADROOM } from './kill-time.js?v=498';
import { HIT_XP_PER_DAMAGE, HIT_HP_XP_PER_DAMAGE } from './styles.js?v=498';
import { WEEKLY_BONUS } from './botd.js?v=498';
