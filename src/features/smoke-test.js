...
// modularised, will import { G } from '../state/game.js?v=156' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=156';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=156';
