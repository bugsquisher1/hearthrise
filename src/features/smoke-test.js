...
// modularised, will import { G } from '../state/game.js?v=157' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=157';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=157';
