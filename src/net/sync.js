...
//   import { setupSync } from './net/sync.js?v=496';
//   setupSync({
...
import { on, snapshot } from './events.js?v=496';
...
import { resolveActiveSlot } from './accrue.js?v=496';
...
import { balanceState } from './balance.js?v=496';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=496';
import { putClientState } from './client-state.js?v=496';
