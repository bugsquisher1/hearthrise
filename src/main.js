...
import { SKILLS_DEF } from './data/skills.js?v=461';
import { MONSTERS } from './data/monsters.js?v=461';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=461';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=461';
import * as ItemArt from './data/item-art.js?v=461';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=461';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=461';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=461';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=461';
import { COMPANIONS } from './data/companions.js?v=461';
import { RAID_BOSSES } from './data/raid-bosses.js?v=461';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=461';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=461';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=461';
...
import './net/events.js?v=461';
import './net/sync.js?v=461';
...
import './net/dungeon-purchase.js?v=461';
...
import './net/predict.js?v=461';
import './net/record.js?v=461';
...
import './net/skill-record.js?v=461';
...
import './net/marks-record.js?v=461';
...
import './net/rooms-record.js?v=461';
...
import './net/rested-record.js?v=461';
...
import './net/equipment-record.js?v=461';
...
import './net/market-history.js?v=461';
import './net/auth.js?v=461';
import './net/supabase-bootstrap.js?v=461';
...
import './net/build-watch.js?v=461';
...
import './config.js?v=461';
import './utils/dom.js?v=461';
import './utils/safe.js?v=461';
import './utils/profile.js?v=461';
import './utils/data-integrity.js?v=461';
import './utils/image-fallback.js?v=461';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=461';
import { setupCompanions } from './features/companions.js?v=461';
import { setupActivitiesGrid } from './features/activities-grid.js?v=461';
import { setupCharacterPage } from './features/character-page.js?v=461';
import { setupCombatRender } from './features/combat-render.js?v=461';
import { setupCombatScreens } from './features/combat-screens.js?v=461';
import { setupRecipeBook } from './features/recipe-book.js?v=461';
import { setupItemIndex } from './features/item-index.js?v=461';
