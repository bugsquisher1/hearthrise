...
//   import { setupSync } from './net/sync.js?v=445';
//   setupSync({
...
import { on, snapshot } from './events.js?v=445';
...
import { resolveActiveSlot } from './accrue.js?v=445';
...
import { balanceState } from './balance.js?v=445';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=445';
import { putClientState } from './client-state.js?v=445';
