...
//   import { setupSync } from './net/sync.js?v=457';
//   setupSync({
...
import { on, snapshot } from './events.js?v=457';
...
import { resolveActiveSlot } from './accrue.js?v=457';
...
import { balanceState } from './balance.js?v=457';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=457';
import { putClientState } from './client-state.js?v=457';
