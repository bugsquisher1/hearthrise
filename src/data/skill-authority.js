...
import { SKILLS_DEF } from './skills.js?v=458';
import { COMBAT_STYLES } from '../core/styles.js?v=458';
import { GATHER_SKILLS } from '../core/pacing.js?v=458';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=458';
