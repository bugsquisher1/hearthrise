...
//   import { setupSync } from './net/sync.js?v=479';
//   setupSync({
...
import { on, snapshot } from './events.js?v=479';
...
import { resolveActiveSlot } from './accrue.js?v=479';
...
import { balanceState } from './balance.js?v=479';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=479';
import { putClientState } from './client-state.js?v=479';
