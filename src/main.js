...
import { SKILLS_DEF } from './data/skills.js?v=255';
import { MONSTERS } from './data/monsters.js?v=255';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=255';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=255';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=255';
import { COMPANIONS } from './data/companions.js?v=255';
...
import './net/events.js?v=255';
import './net/sync.js?v=255';
import './net/auth.js?v=255';
import './net/supabase-bootstrap.js?v=255';
...
import './config.js?v=255';
import './utils/dom.js?v=255';
import './utils/safe.js?v=255';
import './utils/profile.js?v=255';
import './utils/data-integrity.js?v=255';
import './utils/image-fallback.js?v=255';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=255';
import { setupCompanions } from './features/companions.js?v=255';
import { setupActivitiesGrid } from './features/activities-grid.js?v=255';
import { setupCharacterPage } from './features/character-page.js?v=255';
import { setupCombatRender } from './features/combat-render.js?v=255';
import { setupRecipeBook } from './features/recipe-book.js?v=255';
import { setupItemIndex } from './features/item-index.js?v=255';
