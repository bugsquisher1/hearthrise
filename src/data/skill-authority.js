...
import { SKILLS_DEF } from './skills.js?v=447';
import { COMBAT_STYLES } from '../core/styles.js?v=447';
import { GATHER_SKILLS } from '../core/pacing.js?v=447';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=447';
