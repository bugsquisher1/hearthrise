...
import { levelFromXp } from './xp.js?v=480';
import { pacedXp } from './pacing.js?v=480';
import { spendRestedCharge } from './rested.js?v=480';
import { advanceToolCarry } from './tools.js?v=480';
