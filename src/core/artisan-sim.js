...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=518';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=518';
import { actionIntervalMs } from './pacing.js?v=518';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=518';
import { sliceSpan } from './skill-sim.js?v=518';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=518';
import { levelOf } from './xp.js?v=518';
