...
import { levelFromXp } from './xp.js?v=543';
import { pacedXp } from './pacing.js?v=543';
import { spendRestedCharge } from './rested.js?v=543';
import { advanceToolCarry } from './tools.js?v=543';
