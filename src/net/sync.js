...
//   import { setupSync } from './net/sync.js?v=404';
//   setupSync({
...
import { on, snapshot } from './events.js?v=404';
...
import { resolveActiveSlot } from './accrue.js?v=404';
...
import { balanceState } from './balance.js?v=404';
