...
import { SKILLS_DEF } from './data/skills.js?v=342';
import { MONSTERS } from './data/monsters.js?v=342';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=342';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=342';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=342';
import { COMPANIONS } from './data/companions.js?v=342';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=342';
...
import './net/events.js?v=342';
import './net/sync.js?v=342';
...
import './net/record.js?v=342';
import './net/auth.js?v=342';
import './net/supabase-bootstrap.js?v=342';
...
import './net/build-watch.js?v=342';
...
import './config.js?v=342';
import './utils/dom.js?v=342';
import './utils/safe.js?v=342';
import './utils/profile.js?v=342';
import './utils/data-integrity.js?v=342';
import './utils/image-fallback.js?v=342';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=342';
import { setupCompanions } from './features/companions.js?v=342';
import { setupActivitiesGrid } from './features/activities-grid.js?v=342';
import { setupCharacterPage } from './features/character-page.js?v=342';
import { setupCombatRender } from './features/combat-render.js?v=342';
import { setupRecipeBook } from './features/recipe-book.js?v=342';
import { setupItemIndex } from './features/item-index.js?v=342';
