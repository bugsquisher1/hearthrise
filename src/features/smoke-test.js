...
// modularised, will import { G } from '../state/game.js?v=190' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=190';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=190';
