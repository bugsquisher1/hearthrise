...
//   import { setupSync } from './net/sync.js?v=512';
//   setupSync({
...
import { on, snapshot } from './events.js?v=512';
...
import { resolveActiveSlot } from './accrue.js?v=512';
...
import { balanceState } from './balance.js?v=512';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=512';
import { putClientState } from './client-state.js?v=512';
