...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=528';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=528';
import { actionIntervalMs } from './pacing.js?v=528';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=528';
import { sliceSpan } from './skill-sim.js?v=528';
