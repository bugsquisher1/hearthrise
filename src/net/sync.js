...
//   import { setupSync } from './net/sync.js?v=493';
//   setupSync({
...
import { on, snapshot } from './events.js?v=493';
...
import { resolveActiveSlot } from './accrue.js?v=493';
...
import { balanceState } from './balance.js?v=493';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=493';
import { putClientState } from './client-state.js?v=493';
