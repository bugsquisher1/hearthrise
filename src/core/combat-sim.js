...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=532';
import { rollDropTable } from './drops.js?v=532';
import { resolveHearthfind } from './hearthfind.js?v=532';
import { hitXpRoute, killXpRoute } from './styles.js?v=532';
import { applyGoldFind } from './pacing.js?v=532';
...
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments,
         retreatAtFall } from './away.js?v=532';
...
import { chooseFood, resolveAutoEat } from './auto-eat.js?v=532';
/* THE FORECAST's seeded dice (ruling item 7). A fixed seed, never a clock —
   see `forecastFight` at the foot of this file. */
import { createRng } from './rng.js?v=532';
import { NO_BONUS } from './botd.js?v=532';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=532';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=532';
