...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=342';
import { rollDropTable } from './drops.js?v=342';
import { hitXpRoute, killXpRoute } from './styles.js?v=342';
