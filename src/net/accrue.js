...
import * as itemLedger from './item-ledger.js?v=506';
...
import { serverOwnedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=506';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=506';
...
import * as pendingConsume from './pending-consume.js?v=506';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=506';
...
import { notePropertyUnlocks, pickBankRung, isCompleteProgressStatement } from './property-record.js?v=506';
