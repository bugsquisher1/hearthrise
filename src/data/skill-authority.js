...
import { SKILLS_DEF } from './skills.js?v=392';
import { COMBAT_STYLES } from '../core/styles.js?v=392';
import { GATHER_SKILLS } from '../core/pacing.js?v=392';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=392';
