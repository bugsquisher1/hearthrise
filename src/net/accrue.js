...
import * as itemLedger from './item-ledger.js?v=491';
...
import { serverOwnedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=491';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=491';
...
import * as pendingConsume from './pending-consume.js?v=491';
