...
import { MONSTERS } from './data/monsters.js?v=302';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=302';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=302';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=302';
import { COMPANIONS } from './data/companions.js?v=302';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=302';
...
import './net/events.js?v=302';
import './net/sync.js?v=302';
import './net/auth.js?v=302';
import './net/supabase-bootstrap.js?v=302';
...
import './config.js?v=302';
import './utils/dom.js?v=302';
import './utils/safe.js?v=302';
import './utils/profile.js?v=302';
import './utils/data-integrity.js?v=302';
import './utils/image-fallback.js?v=302';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=302';
import { setupCompanions } from './features/companions.js?v=302';
import { setupActivitiesGrid } from './features/activities-grid.js?v=302';
import { setupCharacterPage } from './features/character-page.js?v=302';
import { setupCombatRender } from './features/combat-render.js?v=302';
import { setupRecipeBook } from './features/recipe-book.js?v=302';
import { setupItemIndex } from './features/item-index.js?v=302';
