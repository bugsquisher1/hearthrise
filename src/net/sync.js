...
//   import { setupSync } from './net/sync.js?v=438';
//   setupSync({
...
import { on, snapshot } from './events.js?v=438';
...
import { resolveActiveSlot } from './accrue.js?v=438';
...
import { balanceState } from './balance.js?v=438';
