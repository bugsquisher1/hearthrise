...
insert into public.hr_activities (kind, activity_id, req_skill, req_lv, max_hp, is_boss) values
  ...
  ('artisan','carve_dawnsteel_rod','crafting',94,null,false),
  ('artisan','carve_duskwood_rod','crafting',84,null,false),
  ...
  ('artisan','cook_carrot','cooking',5,null,false),
  ('artisan','cook_carrot_stew','cooking',45,null,false),
  ('artisan','cook_dragon_stew','cooking',85,null,false),
  ('artisan','cook_ember_tart','cooking',78,null,false),
  ('artisan','cook_field_ration','cooking',22,null,false),
  ('artisan','cook_frostfin','cooking',70,null,false),
  ('artisan','cook_goldenroot','cooking',65,null,false),
  ('artisan','cook_herring','cooking',8,null,false),
  ('artisan','cook_hunters_feast','cooking',75,null,false),
  ('artisan','cook_lich_soup','cooking',90,null,false),
  ('artisan','cook_lobster','cooking',30,null,false),
  ('artisan','cook_moon_elixir','cooking',92,null,false),
  ('artisan','cook_moonfish','cooking',88,null,false),
  ('artisan','cook_panther_meat','cooking',25,null,false),
  ('artisan','cook_pumpkin','cooking',40,null,false),
  ('artisan','cook_pumpkin_pie','cooking',60,null,false),
  ('artisan','cook_shark','cooking',60,null,false),
  ('artisan','cook_shrimp','cooking',1,null,false),
  ('artisan','cook_swordfish','cooking',45,null,false),
  ('artisan','cook_tomato_soup','cooking',35,null,false),
  ('artisan','cook_trout','cooking',15,null,false),
  ('artisan','cook_turnip','cooking',1,null,false),
  ('artisan','cook_veg_stew','cooking',50,null,false),
  ('artisan','cook_void_banquet','cooking',99,null,false),
  ('artisan','cook_wheat_bread','cooking',20,null,false),
  ('artisan','cook_wolf_meat','cooking',5,null,false),
  ('artisan','craft_adept_belt','crafting',18,null,false),
  ('artisan','craft_adept_body','crafting',25,null,false),
  ('artisan','craft_adept_boots','crafting',17,null,false),
  ('artisan','craft_adept_gloves','crafting',16,null,false),
  ('artisan','craft_adept_helmet','crafting',20,null,false),
  ('artisan','craft_adept_pants','crafting',23,null,false),
  ('artisan','craft_alpha_cloak','crafting',60,null,false),
  ('artisan','craft_alphaheart_longbow','crafting',50,null,false),
  ('artisan','craft_apprentice_belt','crafting',4,null,false),
  ('artisan','craft_apprentice_body','crafting',11,null,false),
  ('artisan','craft_apprentice_boots','crafting',3,null,false),
  ('artisan','craft_apprentice_gloves','crafting',2,null,false),
  ('artisan','craft_apprentice_helmet','crafting',6,null,false),
  ('artisan','craft_apprentice_pants','crafting',9,null,false),
  ('artisan','craft_archmage_belt','crafting',78,null,false),
  ('artisan','craft_archmage_body','crafting',85,null,false),
  ('artisan','craft_archmage_boots','crafting',77,null,false),
  ('artisan','craft_archmage_gloves','crafting',76,null,false),
  ('artisan','craft_archmage_helmet','crafting',80,null,false),
  ('artisan','craft_archmage_pants','crafting',83,null,false),
  ('artisan','craft_boarhide_belt','crafting',33,null,false),
  ('artisan','craft_boarhide_body','crafting',40,null,false),
  ('artisan','craft_boarhide_boots','crafting',32,null,false),
  ('artisan','craft_boarhide_gloves','crafting',31,null,false),
  ('artisan','craft_boarhide_helmet','crafting',35,null,false),
  ('artisan','craft_boarhide_pants','crafting',38,null,false),
  ('artisan','craft_bone_needle','crafting',5,null,false),
  ('artisan','craft_chitin_belt','crafting',48,null,false),
  ('artisan','craft_chitin_body','crafting',55,null,false),
  ('artisan','craft_chitin_boots','crafting',47,null,false),
  ('artisan','craft_chitin_gloves','crafting',46,null,false),
  ...
  ('artisan','craft_dragonhide_gloves','crafting',76,null,false),
  ('artisan','craft_dragonhide_helmet','crafting',80,null,false),
  ('artisan','craft_dragonhide_pants','crafting',83,null,false),
  ('artisan','craft_dragonrib_bow','crafting',80,null,false),
  ('artisan','craft_fangdart_recurve','crafting',36,null,false),
  ('artisan','craft_gold_amulet','crafting',40,null,false),
  ('artisan','craft_gold_ring','crafting',25,null,false),
  ('artisan','craft_hollow_sigil_ring','crafting',35,null,false),
  ('artisan','craft_iron_arrows','crafting',20,null,false),
  ('artisan','craft_keystone','stonemason',60,null,false),
  ('artisan','craft_leather_belt','crafting',4,null,false),
  ('artisan','craft_leather_body','crafting',11,null,false),
  ('artisan','craft_leather_helmet','crafting',6,null,false),
  ('artisan','craft_leather_pants','crafting',9,null,false),
  ...
  ('artisan','craft_scholar_boots','crafting',32,null,false),
  ('artisan','craft_scholar_gloves','crafting',31,null,false),
  ('artisan','craft_scholar_helmet','crafting',35,null,false),
  ('artisan','craft_scholar_pants','crafting',38,null,false),
  ('artisan','craft_snakeskin_belt','crafting',48,null,false),
  ('artisan','craft_snakeskin_body','crafting',55,null,false),
  ('artisan','craft_snakeskin_boots','crafting',47,null,false),
  ('artisan','craft_snakeskin_gloves','crafting',46,null,false),
  ('artisan','craft_snakeskin_helmet','crafting',50,null,false),
  ('artisan','craft_snakeskin_pants','crafting',53,null,false),
  ('artisan','craft_sorcerer_belt','crafting',63,null,false),
  ('artisan','craft_sorcerer_body','crafting',70,null,false),
  ('artisan','craft_sorcerer_boots','crafting',62,null,false),
  ('artisan','craft_sorcerer_gloves','crafting',61,null,false),
  ('artisan','craft_sorcerer_helmet','crafting',65,null,false),
  ('artisan','craft_sorcerer_pants','crafting',68,null,false),
  ('artisan','craft_steel_needle','crafting',35,null,false),
  ('artisan','craft_studded_belt','crafting',18,null,false),
  ('artisan','craft_studded_body','crafting',25,null,false),
  ('artisan','craft_studded_boots','crafting',17,null,false),
  ('artisan','craft_studded_gloves','crafting',16,null,false),
  ('artisan','craft_studded_helmet','crafting',20,null,false),
  ('artisan','craft_studded_pants','crafting',23,null,false),
  ('artisan','craft_timber_beam','crafting',25,null,false),
  ('artisan','craft_void_censer','crafting',66,null,false),
  ('artisan','craft_voidhide_belt','crafting',91,null,false),
  ('artisan','craft_voidhide_body','crafting',94,null,false),
  ('artisan','craft_voidhide_boots','crafting',90,null,false),
  ('artisan','craft_voidhide_gloves','crafting',89,null,false),
  ('artisan','craft_voidhide_helmet','crafting',93,null,false),
  ('artisan','craft_voidhide_pants','crafting',94,null,false),
  ('artisan','craft_voidweave_belt','crafting',91,null,false),
  ('artisan','craft_voidweave_body','crafting',94,null,false),
  ('artisan','craft_voidweave_boots','crafting',90,null,false),
  ('artisan','craft_voidweave_gloves','crafting',89,null,false),
  ('artisan','craft_voidweave_helmet','crafting',93,null,false),
  ('artisan','craft_voidweave_pants','crafting',94,null,false),
  ('artisan','craft_warlock_belt','crafting',48,null,false),
  ('artisan','craft_warlock_body','crafting',55,null,false),
  ('artisan','craft_warlock_boots','crafting',47,null,false),
  ('artisan','craft_warlock_gloves','crafting',46,null,false),
  ('artisan','craft_warlock_helmet','crafting',50,null,false),
  ('artisan','craft_warlock_pants','crafting',53,null,false),
  ('artisan','craft_wraithsilk_shroud','crafting',52,null,false),
  ('artisan','craft_wyrmgilt_mantle','crafting',95,null,false),
  ('artisan','craft_wyvernhide_belt','crafting',63,null,false),
  ('artisan','craft_wyvernhide_body','crafting',70,null,false),
  ('artisan','craft_wyvernhide_boots','crafting',62,null,false),
  ('artisan','craft_wyvernhide_gloves','crafting',61,null,false),
  ('artisan','craft_wyvernhide_helmet','crafting',65,null,false),
  ('artisan','craft_wyvernhide_pants','crafting',68,null,false),
  ...
  ('artisan','dress_rubble','stonemason',1,null,false),
  ('artisan','fletch_barbed_arrows','crafting',18,null,false),
  ('artisan','fletch_bronze_arrows','crafting',5,null,false),
  ('artisan','fletch_dawnpoint_arrows','crafting',91,null,false),
  ('artisan','fletch_emberhead_arrows','crafting',78,null,false),
  ('artisan','fletch_mithril_arrows','crafting',48,null,false),
  ('artisan','fletch_rune_arrows','crafting',63,null,false),
  ('artisan','fletch_steel_arrows','crafting',33,null,false),
  ('artisan','forge_abyssal_greaves','smithing',97,null,false),
  ('artisan','forge_bramble_blade','smithing',23,null,false),
  ('artisan','forge_bronze_axe','smithing',3,null,false),
  ('artisan','forge_bronze_belt','smithing',4,null,false),
  ('artisan','forge_bronze_boots','smithing',3,null,false),
  ...
  ('artisan','forge_steel_boots','smithing',32,null,false),
  ...
  ('artisan','forge_watchknight_body','smithing',70,null,false),
  ('artisan','forge_watchknight_boots','smithing',62,null,false),
  ('artisan','forge_watchknight_gloves','smithing',61,null,false),
  ('artisan','forge_watchknight_helmet','smithing',65,null,false),
  ...
  ('artisan','jewel_rubyfire_studs','crafting',70,null,false),
  ('artisan','jewel_spellstone_ring','crafting',70,null,false),
  ('artisan','jewel_spidereye_studs','crafting',38,null,false),
  ('artisan','jewel_spidersilk_choker','crafting',38,null,false),
  ('artisan','jewel_warlords_torc','crafting',56,null,false),
  ('artisan','jewel_wolfbone_torc','crafting',20,null,false),
  ('artisan','jewel_wraithglass_drops','crafting',54,null,false),
  ('artisan','make_dawn_sword','smithing',93,null,false),
  ('artisan','make_dawn_warhammer','smithing',96,null,false),
  ('artisan','make_duskwood_bow','crafting',93,null,false),
  ('artisan','make_duskwood_staff','crafting',94,null,false),
  ('artisan','make_ember_sword','smithing',80,null,false),
  ('artisan','make_ember_warhammer','smithing',83,null,false),
  ('artisan','make_maple_bow','crafting',50,null,false),
  ('artisan','make_maple_staff','crafting',51,null,false),
  ('artisan','make_mithril_sword','smithing',50,null,false),
  ('artisan','make_mithril_warhammer','smithing',53,null,false),
  ('artisan','make_rune_warhammer','smithing',68,null,false),
  ('artisan','make_runewood_bow','crafting',80,null,false),
  ('artisan','make_runewood_staff','crafting',81,null,false),
  ('artisan','make_steel_warhammer','smithing',38,null,false),
  ('artisan','make_willow_longbow','crafting',35,null,false),
  ...
  ('combat','archmage',null,null,215,false),
  ...
  ('combat','broodmother',null,null,402,true),
  ('combat','carnivorous_plant',null,null,138,false),
  ('combat','carrion_swarm',null,null,198,false),
  ('combat','cave_wyrm',null,null,158,false),
  ('combat','centipede',null,null,60,false),
  ('combat','chained_demon',null,null,240,false),
  ('combat','clay_golem',null,null,78,false),
  ('combat','conjurer',null,null,110,false),
  ('combat','cutpurse',null,null,11,false),
  ('combat','cyclops',null,null,256,false),
  ('combat','dark_wizard',null,null,28,false),
  ('combat','death_knight',null,null,260,false),
  ('combat','deserter',null,null,57,false),
  ('combat','dire_wolf',null,null,62,false),
  ('combat','draconia',null,null,484,true),
  ('combat','dragon',null,null,520,true),
  ('combat','drake',null,null,234,false),
  ('combat','drowned_dead',null,null,130,false),
  ('combat','dryad',null,null,222,false),
  ('combat','earth_elemental',null,null,74,false),
  ('combat','elder_cinder',null,null,440,true),
  ('combat','elk_king',null,null,466,true),
  ...
  ('combat','giant_bat',null,null,24,false),
  ...
  ('combat','grave_banshee',null,null,194,false),
  ('combat','grim_reaper',null,null,388,true),
  ('combat','hellhound',null,null,122,false),
  ('combat','hive_wasp',null,null,8,false),
  ('combat','hobgoblin',null,null,34,false),
  ('combat','ice_elemental',null,null,128,false),
  ('combat','imp',null,null,10,false),
  ('combat','iron_colossus',null,null,518,true),
  ('combat','kobold',null,null,12,false),
  ('combat','lesser_demon',null,null,150,false),
  ('combat','lich',null,null,350,true),
  ('combat','locust_swarm',null,null,25,false),
  ('combat','lynx',null,null,55,false),
  ('combat','magma_elemental',null,null,226,false),
  ...
  ('combat','rat',null,null,9,false),
  ('combat','revenant',null,null,448,false),
  ('combat','rock_troll',null,null,72,false),
  ('combat','salamander',null,null,27,false),
  ('combat','scarecrow',null,null,16,false),
  ('combat','shadow_creeper',null,null,190,false),
  ('combat','shrieker',null,null,29,false),
  ('combat','skeleton',null,null,35,false),
  ('combat','slime',null,null,8,false),
  ('combat','small_wolf',null,null,16,false),
  ('combat','stag',null,null,26,false),
  ('combat','starhusk',null,null,208,false),
  ('combat','stone_golem',null,null,35,false),
  ('combat','stonejaw',null,null,478,true),
  ('combat','storm_elemental',null,null,392,false),
  ('combat','the_silence',null,null,364,false),
  ('combat','the_unlit',null,null,508,true),
  ('combat','treant',null,null,512,true),
  ('combat','vampire_bride',null,null,372,false),
  ('combat','venom_spider',null,null,52,false),
  ('combat','vharek',null,null,496,true),
  ('combat','void_mote',null,null,104,false),
  ('combat','void_parasite',null,null,340,false),
  ('combat','war_king',null,null,420,false),
  ('combat','warband_captain',null,null,230,false),
  ('combat','warlock',null,null,58,false),
  ('combat','watchknight',null,null,164,false),
  ('combat','water_elemental',null,null,30,false),
  ('combat','weak_skeleton',null,null,14,false),
  ('combat','wight',null,null,30,false),
  ('combat','wild_boar',null,null,13,false),
  ('combat','winter_wolf',null,null,132,false),
  ('combat','witchs_apprentice',null,null,10,false),
  ('combat','wolf',null,null,30,false),
  ('combat','wraith',null,null,112,false),
  ...
  ('gather','normal_tree','woodcutting',1,null,false),
  ('gather','oak_tree','woodcutting',15,null,false),
...
begin
  ...
  if v_n <> 14 then
    raise exception 'combat activities flagged is_boss: %, generator emitted 14 — '
