...
//   import { setupSync } from './net/sync.js?v=442';
//   setupSync({
...
import { on, snapshot } from './events.js?v=442';
...
import { resolveActiveSlot } from './accrue.js?v=442';
...
import { balanceState } from './balance.js?v=442';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=442';
import { putClientState } from './client-state.js?v=442';
