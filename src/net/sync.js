...
//   import { setupSync } from './net/sync.js?v=400';
//   setupSync({
...
import { on, snapshot } from './events.js?v=400';
...
import { resolveActiveSlot } from './accrue.js?v=400';
...
import { balanceState } from './balance.js?v=400';
