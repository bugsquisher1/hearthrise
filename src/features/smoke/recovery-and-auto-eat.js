...
// the 65,656-line monolith on 2026-09-14 — lines 15167–17605, 30 tests, not one renamed.
// ══════════════════════════════════════════════════════════════════════
import { pass, fail, tryRun, tryRunAsync, assert, skip, snapshotG, drain, restoreG, on, snapshot } from './_harness.js?v=546';
