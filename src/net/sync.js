...
//   import { setupSync } from './net/sync.js?v=366';
//   setupSync({
...
import { on, snapshot } from './events.js?v=366';
...
import { resolveActiveSlot } from './accrue.js?v=366';
...
import { balanceState } from './balance.js?v=366';
