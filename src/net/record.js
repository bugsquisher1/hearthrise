...
import { applyClientState } from './client-state.js?v=507';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=507';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=507';
