...
import { MONSTERS } from './data/monsters.js?v=196';
import { ITEMS } from './data/items.js?v=196';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=196';
...
import './net/events.js?v=196';
import './net/sync.js?v=196';
import './net/auth.js?v=196';
import './net/supabase-bootstrap.js?v=196';
...
import './config.js?v=196';
import './utils/dom.js?v=196';
import './utils/safe.js?v=196';
import './utils/profile.js?v=196';
import './utils/data-integrity.js?v=196';
import './utils/image-fallback.js?v=196';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=196';
import { setupCompanions } from './features/companions.js?v=196';
import { setupActivitiesGrid } from './features/activities-grid.js?v=196';
import { setupCharacterPage } from './features/character-page.js?v=196';
import { setupCombatRender } from './features/combat-render.js?v=196';
