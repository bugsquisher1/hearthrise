...
import { SKILLS_DEF } from './data/skills.js?v=155';
import { MONSTERS } from './data/monsters.js?v=155';
import { ITEMS } from './data/items.js?v=155';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=155';
import { ARTISAN_RECIPES } from './data/recipes.js?v=155';
import { COMPANIONS } from './data/companions.js?v=155';
...
import './net/events.js?v=155';
import './net/sync.js?v=155';
import './net/auth.js?v=155';
import './net/supabase-bootstrap.js?v=155';
...
import './utils/dom.js?v=155';
import './utils/safe.js?v=155';
import './utils/profile.js?v=155';
import './utils/data-integrity.js?v=155';
import './utils/image-fallback.js?v=155';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=155';
import { setupCompanions } from './features/companions.js?v=155';
import { setupActivitiesGrid } from './features/activities-grid.js?v=155';
import { setupCharacterPage } from './features/character-page.js?v=155';
import { setupCombatRender } from './features/combat-render.js?v=155';
