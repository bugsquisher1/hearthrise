...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=524';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=524';
import { actionIntervalMs } from './pacing.js?v=524';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=524';
import { sliceSpan } from './skill-sim.js?v=524';
