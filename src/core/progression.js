...
import { levelFromXp } from './xp.js?v=417';
import { pacedXp } from './pacing.js?v=417';
import { spendRestedCharge } from './rested.js?v=417';
import { advanceToolCarry } from './tools.js?v=417';
