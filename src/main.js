...
import { SKILLS_DEF } from './data/skills.js?v=428';
import { MONSTERS } from './data/monsters.js?v=428';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=428';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=428';
import * as ItemArt from './data/item-art.js?v=428';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=428';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=428';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=428';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=428';
import { COMPANIONS } from './data/companions.js?v=428';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=428';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=428';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=428';
...
import './net/events.js?v=428';
import './net/sync.js?v=428';
...
import './net/dungeon-purchase.js?v=428';
...
import './net/market-history.js?v=428';
import './net/auth.js?v=428';
import './net/supabase-bootstrap.js?v=428';
...
import './net/build-watch.js?v=428';
...
import './config.js?v=428';
import './utils/dom.js?v=428';
import './utils/safe.js?v=428';
import './utils/profile.js?v=428';
import './utils/data-integrity.js?v=428';
import './utils/image-fallback.js?v=428';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=428';
import { setupCompanions } from './features/companions.js?v=428';
import { setupActivitiesGrid } from './features/activities-grid.js?v=428';
import { setupCharacterPage } from './features/character-page.js?v=428';
import { setupCombatRender } from './features/combat-render.js?v=428';
import { setupCombatScreens } from './features/combat-screens.js?v=428';
import { setupRecipeBook } from './features/recipe-book.js?v=428';
import { setupItemIndex } from './features/item-index.js?v=428';
