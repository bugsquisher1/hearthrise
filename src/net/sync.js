...
//   import { setupSync } from './net/sync.js?v=383';
//   setupSync({
...
import { on, snapshot } from './events.js?v=383';
...
import { resolveActiveSlot } from './accrue.js?v=383';
...
import { balanceState } from './balance.js?v=383';
