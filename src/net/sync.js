...
//   import { setupSync } from './net/sync.js?v=423';
//   setupSync({
...
import { on, snapshot } from './events.js?v=423';
...
import { resolveActiveSlot } from './accrue.js?v=423';
...
import { balanceState } from './balance.js?v=423';
