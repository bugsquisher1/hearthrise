...
//   import { setupSync } from './net/sync.js?v=429';
//   setupSync({
...
import { on, snapshot } from './events.js?v=429';
...
import { resolveActiveSlot } from './accrue.js?v=429';
...
import { balanceState } from './balance.js?v=429';
