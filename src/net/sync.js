...
//   import { setupSync } from './net/sync.js?v=463';
//   setupSync({
...
import { on, snapshot } from './events.js?v=463';
...
import { resolveActiveSlot } from './accrue.js?v=463';
...
import { balanceState } from './balance.js?v=463';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=463';
import { putClientState } from './client-state.js?v=463';
