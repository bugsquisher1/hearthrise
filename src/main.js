...
import { SKILLS_DEF } from './data/skills.js?v=524';
import { MONSTERS } from './data/monsters.js?v=524';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=524';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=524';
import * as ItemArt from './data/item-art.js?v=524';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=524';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=524';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=524';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=524';
import { COMPANIONS } from './data/companions.js?v=524';
import { RAID_BOSSES } from './data/raid-bosses.js?v=524';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=524';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=524';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=524';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=524';
...
import './net/events.js?v=524';
import './net/sync.js?v=524';
...
import './net/dungeon-purchase.js?v=524';
...
import './net/predict.js?v=524';
import './net/record.js?v=524';
...
import './net/skill-record.js?v=524';
...
import './net/marks-record.js?v=524';
...
import './net/rooms-record.js?v=524';
...
import './net/property-record.js?v=524';
...
import './net/rested-record.js?v=524';
...
import './net/equipment-record.js?v=524';
...
import './net/dungeon-scrip-record.js?v=524';
import './net/dungeon-settle.js?v=524';
...
import './net/market-history.js?v=524';
import './net/auth.js?v=524';
import './net/supabase-bootstrap.js?v=524';
...
import './features/boot-hydration.js?v=524';
...
import './net/build-watch.js?v=524';
...
import './config.js?v=524';
import './utils/dom.js?v=524';
import './utils/safe.js?v=524';
import './utils/profile.js?v=524';
import './utils/data-integrity.js?v=524';
import './utils/image-fallback.js?v=524';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=524';
import { setupCompanions } from './features/companions.js?v=524';
import { setupActivitiesGrid } from './features/activities-grid.js?v=524';
import { setupCharacterPage } from './features/character-page.js?v=524';
import { setupCombatRender } from './features/combat-render.js?v=524';
import { setupCombatScreens } from './features/combat-screens.js?v=524';
import { setupRecipeBook } from './features/recipe-book.js?v=524';
import { setupItemIndex } from './features/item-index.js?v=524';
