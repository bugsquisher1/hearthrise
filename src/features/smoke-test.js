...
// modularised, will import { G } from '../state/game.js?v=220' directly.
//
// Triggered by:
...
import { on } from '../net/events.js?v=220';
import { findUiOverlaps, watchUiOverlaps } from './ui-overlap.js?v=220';
