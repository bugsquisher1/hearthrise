...
import { levelFromXp } from './xp.js?v=506';
import { pacedXp } from './pacing.js?v=506';
import { spendRestedCharge } from './rested.js?v=506';
import { advanceToolCarry } from './tools.js?v=506';
