...
//   import { setupSync } from './net/sync.js?v=398';
//   setupSync({
...
import { on, snapshot } from './events.js?v=398';
...
import { resolveActiveSlot } from './accrue.js?v=398';
...
import { balanceState } from './balance.js?v=398';
