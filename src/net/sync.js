...
//   import { setupSync } from './net/sync.js?v=509';
//   setupSync({
...
import { on, snapshot } from './events.js?v=509';
...
import { resolveActiveSlot } from './accrue.js?v=509';
...
import { balanceState } from './balance.js?v=509';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=509';
import { putClientState } from './client-state.js?v=509';
