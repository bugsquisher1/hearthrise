...
//   import { setupSync } from './net/sync.js?v=500';
//   setupSync({
...
import { on, snapshot } from './events.js?v=500';
...
import { resolveActiveSlot } from './accrue.js?v=500';
...
import { balanceState } from './balance.js?v=500';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=500';
import { putClientState } from './client-state.js?v=500';
