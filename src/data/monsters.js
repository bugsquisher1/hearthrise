...
export const MONSTERS={
  ...
  small_wolf:{name:'Small Wolf',icon:'🐺',tier:1,family:'Beast',weaponWeak:'neutral',hp:16,atk:5,def:1,xp:14,gp:[3,9],drops:[{id:'wolf_pelt',ch:.32},{id:'small_fang',ch:.18},{id:'bones',ch:1},{id:'raw_wolf_meat',ch:.6}]},
  ...
  wolf:{name:'Wolf',icon:'🐺',tier:2,family:'Beast',weaponWeak:'hammer',hp:30,atk:8,def:3,xp:30,gp:[5,15],drops:[{id:'wolf_pelt',ch:.7},{id:'small_fang',ch:.35},{id:'bones',ch:1},{id:'raw_wolf_meat',ch:.7}]},
  ...
  warband_captain:{name:'Warband Captain',icon:'🛡️',tier:5,family:'Goblinoid',weaponWeak:'sword',hp:230,atk:54,def:34,xp:540,gp:[110,225],drops:[{id:'warlord_badge',ch:.4},{id:'captain_medal',ch:.12},{id:'rune_sword',ch:.006},{id:'captain_recipe',ch:.03}]},
  panther:{name:'Night Panther',icon:'🐈‍⬛',tier:5,family:'Beast',weaponWeak:'ranged',hp:205,atk:60,def:25,xp:520,gp:[100,210],drops:[{id:'shadow_pelt',ch:.65},{id:'razor_claw',ch:.3},{id:'ruby',ch:.03},{id:'raw_panther_meat',ch:.7}]},
