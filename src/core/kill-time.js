...
import { COMBAT_BALANCE } from './combat.js?v=519';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=519';
import { TOTAL_CAP } from './perks.js?v=519';
import { COMBAT_STYLES } from './styles.js?v=519';
import { ITEMS } from '../data/items.js?v=519';
