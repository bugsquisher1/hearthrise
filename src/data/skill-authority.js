...
import { SKILLS_DEF } from './skills.js?v=438';
import { COMBAT_STYLES } from '../core/styles.js?v=438';
import { GATHER_SKILLS } from '../core/pacing.js?v=438';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=438';
