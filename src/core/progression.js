...
import { levelFromXp } from './xp.js?v=474';
import { pacedXp } from './pacing.js?v=474';
import { spendRestedCharge } from './rested.js?v=474';
import { advanceToolCarry } from './tools.js?v=474';
