...
//   import { setupSync } from './net/sync.js?v=402';
//   setupSync({
...
import { on, snapshot } from './events.js?v=402';
...
import { resolveActiveSlot } from './accrue.js?v=402';
...
import { balanceState } from './balance.js?v=402';
