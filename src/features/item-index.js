...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=410';
import { ITEM_DESC } from '../data/item-descriptions.js?v=410';
import { SHOP_OFFERS } from '../data/shops.js?v=410';
