...
//   import { setupSync } from './net/sync.js?v=424';
//   setupSync({
...
import { on, snapshot } from './events.js?v=424';
...
import { resolveActiveSlot } from './accrue.js?v=424';
...
import { balanceState } from './balance.js?v=424';
