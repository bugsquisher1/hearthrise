...
//   import { setupSync } from './net/sync.js?v=480';
//   setupSync({
...
import { on, snapshot } from './events.js?v=480';
...
import { resolveActiveSlot } from './accrue.js?v=480';
...
import { balanceState } from './balance.js?v=480';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=480';
import { putClientState } from './client-state.js?v=480';
