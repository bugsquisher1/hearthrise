...
//   import { setupSync } from './net/sync.js?v=408';
//   setupSync({
...
import { on, snapshot } from './events.js?v=408';
...
import { resolveActiveSlot } from './accrue.js?v=408';
...
import { balanceState } from './balance.js?v=408';
