...
//   import { setupSync } from './net/sync.js?v=448';
//   setupSync({
...
import { on, snapshot } from './events.js?v=448';
...
import { resolveActiveSlot } from './accrue.js?v=448';
...
import { balanceState } from './balance.js?v=448';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=448';
import { putClientState } from './client-state.js?v=448';
