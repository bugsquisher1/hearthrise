...
//   import { setupSync } from './net/sync.js?v=508';
//   setupSync({
...
import { on, snapshot } from './events.js?v=508';
...
import { resolveActiveSlot } from './accrue.js?v=508';
...
import { balanceState } from './balance.js?v=508';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=508';
import { putClientState } from './client-state.js?v=508';
