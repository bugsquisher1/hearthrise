...
import { COMBAT_BALANCE } from './combat.js?v=549';
import { MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=549';
import { TOTAL_CAP } from './perks.js?v=549';
import { COMBAT_STYLES } from './styles.js?v=549';
import { ITEMS } from '../data/items.js?v=549';
