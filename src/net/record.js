...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank, reconcileBankRungs, reconcileWorkers, reconcileHeroSlots } from './accrue.js?v=509';
...
import { applyClientState } from './client-state.js?v=509';
...
import { isDungeonSettleArmed } from './dungeon-scrip-record.js?v=509';
...
import { coverageBoundary, retirePredictions, reconcileCreditedXp, resetPredictions } from './predict.js?v=509';
