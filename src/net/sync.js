...
//   import { setupSync } from './net/sync.js?v=472';
//   setupSync({
...
import { on, snapshot } from './events.js?v=472';
...
import { resolveActiveSlot } from './accrue.js?v=472';
...
import { balanceState } from './balance.js?v=472';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=472';
import { putClientState } from './client-state.js?v=472';
