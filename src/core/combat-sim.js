...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=514';
import { rollDropTable } from './drops.js?v=514';
import { hitXpRoute, killXpRoute } from './styles.js?v=514';
import { applyGoldFind } from './pacing.js?v=514';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments } from './away.js?v=514';
import { NO_BONUS } from './botd.js?v=514';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=514';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=514';
