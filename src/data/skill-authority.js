...
import { SKILLS_DEF } from './skills.js?v=512';
import { COMBAT_STYLES } from '../core/styles.js?v=512';
import { GATHER_SKILLS } from '../core/pacing.js?v=512';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=512';
