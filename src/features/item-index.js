...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=408';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=408';
import { ITEM_DESC } from '../data/item-descriptions.js?v=408';
import { SHOP_OFFERS } from '../data/shops.js?v=408';
