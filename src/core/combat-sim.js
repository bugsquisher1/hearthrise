...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=507';
import { rollDropTable } from './drops.js?v=507';
import { hitXpRoute, killXpRoute } from './styles.js?v=507';
import { applyGoldFind } from './pacing.js?v=507';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, utcDaySegments } from './away.js?v=507';
import { NO_BONUS } from './botd.js?v=507';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=507';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=507';
