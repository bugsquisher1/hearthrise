...
import { serverOwnedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=470';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=470';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=470';
