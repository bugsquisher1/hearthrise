...
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS } from '../data/gathering.js?v=458';
import { ARTISAN_RECIPES } from '../data/recipes.js?v=458';
...
import { balanceMarkup } from '../net/balance.js?v=458';
