...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      '.hr-id-lead{font-size:13.5px;color:var(--ink-3,#a2968a);line-height:1.5;margin:0 0 14px}',
      ...
      '.hr-id-note{min-height:17px;font-size:13.5px;margin:8px 2px 0;line-height:1.35}',
      ...
      '  padding:5px 4px;font:inherit;font-size:13.5px;font-weight:800;letter-spacing:.09em;',
      ...
      '.hr-id-badge{font-size:13.5px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;',
      ...
      '.hr-id-link{background:none;border:0;padding:0;font:inherit;font-size:13.5px;',
