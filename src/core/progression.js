...
import { levelFromXp } from './xp.js?v=383';
import { pacedXp } from './pacing.js?v=383';
import { spendRestedCharge } from './rested.js?v=383';
import { advanceToolCarry } from './tools.js?v=383';
