...
import { levelFromXp } from './xp.js?v=453';
import { pacedXp } from './pacing.js?v=453';
import { spendRestedCharge } from './rested.js?v=453';
import { advanceToolCarry } from './tools.js?v=453';
