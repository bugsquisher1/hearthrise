...
//   import { setupSync } from './net/sync.js?v=469';
//   setupSync({
...
import { on, snapshot } from './events.js?v=469';
...
import { resolveActiveSlot } from './accrue.js?v=469';
...
import { balanceState } from './balance.js?v=469';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=469';
import { putClientState } from './client-state.js?v=469';
