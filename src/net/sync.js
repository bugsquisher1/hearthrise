...
//   import { setupSync } from './net/sync.js?v=450';
//   setupSync({
...
import { on, snapshot } from './events.js?v=450';
...
import { resolveActiveSlot } from './accrue.js?v=450';
...
import { balanceState } from './balance.js?v=450';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=450';
import { putClientState } from './client-state.js?v=450';
