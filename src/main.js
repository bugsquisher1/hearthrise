...
import { MONSTERS } from './data/monsters.js?v=355';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=355';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=355';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=355';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=355';
import { COMPANIONS } from './data/companions.js?v=355';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=355';
...
import './net/events.js?v=355';
import './net/sync.js?v=355';
...
import './net/gold.js?v=355';
import './net/auth.js?v=355';
import './net/supabase-bootstrap.js?v=355';
...
import './net/build-watch.js?v=355';
...
import './config.js?v=355';
import './utils/dom.js?v=355';
import './utils/safe.js?v=355';
import './utils/profile.js?v=355';
import './utils/data-integrity.js?v=355';
import './utils/image-fallback.js?v=355';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=355';
import { setupCompanions } from './features/companions.js?v=355';
import { setupActivitiesGrid } from './features/activities-grid.js?v=355';
import { setupCharacterPage } from './features/character-page.js?v=355';
import { setupCombatRender } from './features/combat-render.js?v=355';
import { setupRecipeBook } from './features/recipe-book.js?v=355';
import { setupItemIndex } from './features/item-index.js?v=355';
