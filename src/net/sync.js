...
//   import { setupSync } from './net/sync.js?v=389';
//   setupSync({
...
import { on, snapshot } from './events.js?v=389';
...
import { resolveActiveSlot } from './accrue.js?v=389';
...
import { balanceState } from './balance.js?v=389';
