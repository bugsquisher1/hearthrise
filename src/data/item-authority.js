...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from './gathering.js?v=551';
import { ARTISAN_RECIPES } from './recipes.js?v=551';
import { MONSTERS } from './monsters.js?v=551';
import { BOSSES } from './bosses.js?v=551';
import { ITEMS } from './items.js?v=551';
...
import { QM_STOCK } from './dungeons.js?v=551';
import { SHOP_OFFERS } from './shops.js?v=551';
import { QUEST_REWARDS, DAILY_TASK_REWARDS } from './goal-catalogue.js?v=551';
import { RAID_BOSSES } from './raid-bosses.js?v=551';
...
import { BURNT_ITEM } from '../core/artisan.js?v=551';
