...
import { resolveGatherAction } from './progression.js?v=348';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=348';
import { actionIntervalMs, MIN_ACTION_MS, GATHER_SKILLS } from './pacing.js?v=348';
import { rateMult } from './away.js?v=348';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=348';
import { levelOf } from './xp.js?v=348';
