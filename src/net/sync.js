...
//   import { setupSync } from './net/sync.js?v=417';
//   setupSync({
...
import { on, snapshot } from './events.js?v=417';
...
import { resolveActiveSlot } from './accrue.js?v=417';
...
import { balanceState } from './balance.js?v=417';
