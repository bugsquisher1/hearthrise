...
//   import { setupSync } from './net/sync.js?v=495';
//   setupSync({
...
import { on, snapshot } from './events.js?v=495';
...
import { resolveActiveSlot } from './accrue.js?v=495';
...
import { balanceState } from './balance.js?v=495';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=495';
import { putClientState } from './client-state.js?v=495';
