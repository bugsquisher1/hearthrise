...
//   import { setupSync } from './net/sync.js?v=484';
//   setupSync({
...
import { on, snapshot } from './events.js?v=484';
...
import { resolveActiveSlot } from './accrue.js?v=484';
...
import { balanceState } from './balance.js?v=484';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=484';
import { putClientState } from './client-state.js?v=484';
