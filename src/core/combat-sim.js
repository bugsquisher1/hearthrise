...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=515';
import { rollDropTable } from './drops.js?v=515';
import { hitXpRoute, killXpRoute } from './styles.js?v=515';
import { applyGoldFind } from './pacing.js?v=515';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, recoveryFor, resumeHpFor, utcDaySegments } from './away.js?v=515';
import { NO_BONUS } from './botd.js?v=515';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=515';
...
import { spendForSwings, applyAmmoMult } from './ammo.js?v=515';
