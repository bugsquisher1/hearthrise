...
import { SKILLS_DEF } from './data/skills.js?v=498';
import { MONSTERS } from './data/monsters.js?v=498';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=498';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=498';
import * as ItemArt from './data/item-art.js?v=498';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=498';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=498';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=498';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=498';
import { COMPANIONS } from './data/companions.js?v=498';
import { RAID_BOSSES } from './data/raid-bosses.js?v=498';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=498';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=498';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=498';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=498';
...
import './net/events.js?v=498';
import './net/sync.js?v=498';
...
import './net/dungeon-purchase.js?v=498';
...
import './net/predict.js?v=498';
import './net/record.js?v=498';
...
import './net/skill-record.js?v=498';
...
import './net/marks-record.js?v=498';
...
import './net/rooms-record.js?v=498';
...
import './net/property-record.js?v=498';
...
import './net/rested-record.js?v=498';
...
import './net/equipment-record.js?v=498';
...
import './net/market-history.js?v=498';
import './net/auth.js?v=498';
import './net/supabase-bootstrap.js?v=498';
...
import './features/boot-hydration.js?v=498';
...
import './net/build-watch.js?v=498';
...
import './config.js?v=498';
import './utils/dom.js?v=498';
import './utils/safe.js?v=498';
import './utils/profile.js?v=498';
import './utils/data-integrity.js?v=498';
import './utils/image-fallback.js?v=498';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=498';
import { setupCompanions } from './features/companions.js?v=498';
import { setupActivitiesGrid } from './features/activities-grid.js?v=498';
import { setupCharacterPage } from './features/character-page.js?v=498';
import { setupCombatRender } from './features/combat-render.js?v=498';
import { setupCombatScreens } from './features/combat-screens.js?v=498';
import { setupRecipeBook } from './features/recipe-book.js?v=498';
import { setupItemIndex } from './features/item-index.js?v=498';
