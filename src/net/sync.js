...
//   import { setupSync } from './net/sync.js?v=430';
//   setupSync({
...
import { on, snapshot } from './events.js?v=430';
...
import { resolveActiveSlot } from './accrue.js?v=430';
...
import { balanceState } from './balance.js?v=430';
