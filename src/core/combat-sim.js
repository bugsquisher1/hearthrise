...
import { COMBAT_BALANCE, rollAttack, rollCrit, applyCrit } from './combat.js?v=389';
import { rollDropTable } from './drops.js?v=389';
import { hitXpRoute, killXpRoute } from './styles.js?v=389';
import { applyGoldFind } from './pacing.js?v=389';
import { AWAY_RATE_MULT, CHANNEL, channelApplies, rateMult, utcDaySegments } from './away.js?v=389';
import { NO_BONUS } from './botd.js?v=389';
import { tickBuffs, pruneBuffs, hasActiveBuff } from './buffs.js?v=389';
