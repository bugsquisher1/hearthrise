...
import { SKILLS_DEF } from './data/skills.js?v=222';
import { MONSTERS } from './data/monsters.js?v=222';
import { ITEMS, foodClassOf, isAutoEatable } from './data/items.js?v=222';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=222';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=222';
import { COMPANIONS } from './data/companions.js?v=222';
...
import './net/events.js?v=222';
import './net/sync.js?v=222';
import './net/auth.js?v=222';
import './net/supabase-bootstrap.js?v=222';
...
import './config.js?v=222';
import './utils/dom.js?v=222';
import './utils/safe.js?v=222';
import './utils/profile.js?v=222';
import './utils/data-integrity.js?v=222';
import './utils/image-fallback.js?v=222';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=222';
import { setupCompanions } from './features/companions.js?v=222';
import { setupActivitiesGrid } from './features/activities-grid.js?v=222';
import { setupCharacterPage } from './features/character-page.js?v=222';
import { setupCombatRender } from './features/combat-render.js?v=222';
