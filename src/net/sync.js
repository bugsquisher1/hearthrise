...
//   import { setupSync } from './net/sync.js?v=358';
//   setupSync({
...
import { on, snapshot } from './events.js?v=358';
...
import { resolveActiveSlot } from './accrue.js?v=358';
...
import { balanceState } from './balance.js?v=358';
