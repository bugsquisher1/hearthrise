...
//   import { setupSync } from './net/sync.js?v=415';
//   setupSync({
...
import { on, snapshot } from './events.js?v=415';
...
import { resolveActiveSlot } from './accrue.js?v=415';
...
import { balanceState } from './balance.js?v=415';
