...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=523';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=523';
import { actionIntervalMs } from './pacing.js?v=523';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=523';
import { sliceSpan } from './skill-sim.js?v=523';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=523';
import { levelOf } from './xp.js?v=523';
