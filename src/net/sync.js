...
//   import { setupSync } from './net/sync.js?v=488';
//   setupSync({
...
import { on, snapshot } from './events.js?v=488';
...
import { resolveActiveSlot } from './accrue.js?v=488';
...
import { balanceState } from './balance.js?v=488';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=488';
import { putClientState } from './client-state.js?v=488';
