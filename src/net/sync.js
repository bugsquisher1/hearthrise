...
//   import { setupSync } from './net/sync.js?v=535';
//   setupSync({
...
import { on, snapshot } from './events.js?v=535';
...
import { buildLoadRequest, classifyLoadResponse } from './record.js?v=535';
/* ── THE CAPSTONE SAVE PATH (blob-retire — the ONLY path since b515) ─────────
   ...
   sync.js. */
import { buildResiduePatch } from './capstone.js?v=535';
import { putClientState, isClientStateFromServer } from './client-state.js?v=535';
