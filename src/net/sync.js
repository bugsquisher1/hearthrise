...
//   import { setupSync } from './net/sync.js?v=471';
//   setupSync({
...
import { on, snapshot } from './events.js?v=471';
...
import { resolveActiveSlot } from './accrue.js?v=471';
...
import { balanceState } from './balance.js?v=471';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=471';
import { putClientState } from './client-state.js?v=471';
