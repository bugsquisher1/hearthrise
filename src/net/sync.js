...
//   import { setupSync } from './net/sync.js?v=422';
//   setupSync({
...
import { on, snapshot } from './events.js?v=422';
...
import { resolveActiveSlot } from './accrue.js?v=422';
...
import { balanceState } from './balance.js?v=422';
