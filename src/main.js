...
import { SKILLS_DEF } from './data/skills.js?v=526';
import { MONSTERS } from './data/monsters.js?v=526';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=526';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=526';
import * as ItemArt from './data/item-art.js?v=526';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=526';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=526';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=526';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=526';
import { COMPANIONS } from './data/companions.js?v=526';
import { RAID_BOSSES } from './data/raid-bosses.js?v=526';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=526';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=526';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=526';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=526';
...
import './net/events.js?v=526';
import './net/sync.js?v=526';
...
import './net/dungeon-purchase.js?v=526';
...
import './net/predict.js?v=526';
import './net/record.js?v=526';
...
import './net/skill-record.js?v=526';
...
import './net/marks-record.js?v=526';
...
import './net/rooms-record.js?v=526';
...
import './net/property-record.js?v=526';
...
import './net/rested-record.js?v=526';
...
import './net/equipment-record.js?v=526';
...
import './net/dungeon-scrip-record.js?v=526';
import './net/dungeon-settle.js?v=526';
...
import './net/market-history.js?v=526';
import './net/auth.js?v=526';
import './net/supabase-bootstrap.js?v=526';
...
import './features/boot-hydration.js?v=526';
...
import './net/build-watch.js?v=526';
...
import './config.js?v=526';
import './utils/dom.js?v=526';
import './utils/safe.js?v=526';
import './utils/profile.js?v=526';
import './utils/data-integrity.js?v=526';
import './utils/image-fallback.js?v=526';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=526';
import { setupCompanions } from './features/companions.js?v=526';
import { setupActivitiesGrid } from './features/activities-grid.js?v=526';
import { setupCharacterPage } from './features/character-page.js?v=526';
import { setupCombatRender } from './features/combat-render.js?v=526';
import { setupCombatScreens } from './features/combat-screens.js?v=526';
import { setupRecipeBook } from './features/recipe-book.js?v=526';
import { setupItemIndex } from './features/item-index.js?v=526';
