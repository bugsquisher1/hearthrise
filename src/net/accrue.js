...
import * as itemLedger from './item-ledger.js?v=530';
...
import { serverOwnedItem, serverConsumedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=530';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=530';
...
import * as pendingConsume from './pending-consume.js?v=530';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=530';
...
import { notePropertyUnlocks, pickBankRung, isCompleteProgressStatement } from './property-record.js?v=530';
...
import { companionLevelFromXp } from '../core/companion-perk.js?v=530';
