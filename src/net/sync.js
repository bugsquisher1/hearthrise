...
//   import { setupSync } from './net/sync.js?v=380';
//   setupSync({
...
import { on, snapshot } from './events.js?v=380';
...
import { resolveActiveSlot } from './accrue.js?v=380';
...
import { balanceState } from './balance.js?v=380';
