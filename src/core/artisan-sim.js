...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=519';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=519';
import { actionIntervalMs } from './pacing.js?v=519';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=519';
import { sliceSpan } from './skill-sim.js?v=519';
import { nextBuffExpiryMs, hasActiveBuff, tickBuffs, pruneBuffs } from './buffs.js?v=519';
import { levelOf } from './xp.js?v=519';
