...
import { SKILLS_DEF } from './data/skills.js?v=220';
import { MONSTERS } from './data/monsters.js?v=220';
import { ITEMS, foodClassOf, isAutoEatable } from './data/items.js?v=220';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=220';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes } from './data/recipes.js?v=220';
import { COMPANIONS } from './data/companions.js?v=220';
...
import './net/events.js?v=220';
import './net/sync.js?v=220';
import './net/auth.js?v=220';
import './net/supabase-bootstrap.js?v=220';
...
import './config.js?v=220';
import './utils/dom.js?v=220';
import './utils/safe.js?v=220';
import './utils/profile.js?v=220';
import './utils/data-integrity.js?v=220';
import './utils/image-fallback.js?v=220';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=220';
import { setupCompanions } from './features/companions.js?v=220';
import { setupActivitiesGrid } from './features/activities-grid.js?v=220';
import { setupCharacterPage } from './features/character-page.js?v=220';
import { setupCombatRender } from './features/combat-render.js?v=220';
