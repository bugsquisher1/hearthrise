...
//   import { setupSync } from './net/sync.js?v=548';
//   setupSync({
...
import { on, snapshot } from './events.js?v=548';
...
import { resolveActiveSlot } from './accrue.js?v=548';
...
import { buildLoadRequest, classifyLoadResponse } from './record.js?v=548';
/* ── THE CAPSTONE SAVE PATH (blob-retire — the ONLY path since b515) ─────────
   ...
   sync.js. */
import { buildResiduePatch } from './capstone.js?v=548';
import { putClientState, isClientStateFromServer } from './client-state.js?v=548';
