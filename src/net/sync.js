...
//   import { setupSync } from './net/sync.js?v=465';
//   setupSync({
...
import { on, snapshot } from './events.js?v=465';
...
import { resolveActiveSlot } from './accrue.js?v=465';
...
import { balanceState } from './balance.js?v=465';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=465';
import { putClientState } from './client-state.js?v=465';
