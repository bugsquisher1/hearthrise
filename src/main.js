...
import { SKILLS_DEF } from './data/skills.js?v=201';
import { MONSTERS } from './data/monsters.js?v=201';
import { ITEMS } from './data/items.js?v=201';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=201';
import { ARTISAN_RECIPES } from './data/recipes.js?v=201';
import { COMPANIONS } from './data/companions.js?v=201';
...
import './net/events.js?v=201';
import './net/sync.js?v=201';
import './net/auth.js?v=201';
import './net/supabase-bootstrap.js?v=201';
...
import './config.js?v=201';
import './utils/dom.js?v=201';
import './utils/safe.js?v=201';
import './utils/profile.js?v=201';
import './utils/data-integrity.js?v=201';
import './utils/image-fallback.js?v=201';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=201';
import { setupCompanions } from './features/companions.js?v=201';
import { setupActivitiesGrid } from './features/activities-grid.js?v=201';
import { setupCharacterPage } from './features/character-page.js?v=201';
import { setupCombatRender } from './features/combat-render.js?v=201';
