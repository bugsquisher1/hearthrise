...
import { SKILLS_DEF } from './data/skills.js?v=380';
import { MONSTERS } from './data/monsters.js?v=380';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=380';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=380';
import * as ItemArt from './data/item-art.js?v=380';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=380';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=380';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=380';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=380';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=380';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=380';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=380';
...
import './net/events.js?v=380';
import './net/sync.js?v=380';
...
import './net/dungeon-purchase.js?v=380';
...
import './net/market-history.js?v=380';
import './net/auth.js?v=380';
import './net/supabase-bootstrap.js?v=380';
...
import './net/build-watch.js?v=380';
...
import './config.js?v=380';
import './utils/dom.js?v=380';
import './utils/safe.js?v=380';
import './utils/profile.js?v=380';
import './utils/data-integrity.js?v=380';
import './utils/image-fallback.js?v=380';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=380';
import { setupCompanions } from './features/companions.js?v=380';
import { setupActivitiesGrid } from './features/activities-grid.js?v=380';
import { setupCharacterPage } from './features/character-page.js?v=380';
import { setupCombatRender } from './features/combat-render.js?v=380';
import { setupCombatScreens } from './features/combat-screens.js?v=380';
import { setupRecipeBook } from './features/recipe-book.js?v=380';
import { setupItemIndex } from './features/item-index.js?v=380';
