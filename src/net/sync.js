...
//   import { setupSync } from './net/sync.js?v=498';
//   setupSync({
...
import { on, snapshot } from './events.js?v=498';
...
import { resolveActiveSlot } from './accrue.js?v=498';
...
import { balanceState } from './balance.js?v=498';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=498';
import { putClientState } from './client-state.js?v=498';
