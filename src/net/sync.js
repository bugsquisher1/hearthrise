...
//   import { setupSync } from './net/sync.js?v=505';
//   setupSync({
...
import { on, snapshot } from './events.js?v=505';
...
import { resolveActiveSlot } from './accrue.js?v=505';
...
import { balanceState } from './balance.js?v=505';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=505';
import { putClientState } from './client-state.js?v=505';
