...
import { isElement, elementMultFor, MAX_TOTAL_DAMAGE_MULT } from './elements.js?v=553';
...
import { charmDropMultFor, charmRankFor } from './charms.js?v=553';
