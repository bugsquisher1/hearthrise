...
//
// Moved verbatim out of src/features/smoke-test.js (2026-09-14): assert/skip,
// tryRun/tryRunAsync, snapshotG/restoreG/sealSnapshot, the fixture factories and
// the environment probes every domain module shares. Nothing here is new — the
// only edits are the `export` keywords, which is what makes one file into many.
//
// The runner (runSmokeTest) stayed in ../smoke-test.js with the registry, because
// it owns the PLAN and the parks around it, not the fixtures.
// ══════════════════════════════════════════════════════════════════════
