...
import { levelFromXp } from './xp.js?v=479';
import { pacedXp } from './pacing.js?v=479';
import { spendRestedCharge } from './rested.js?v=479';
import { advanceToolCarry } from './tools.js?v=479';
