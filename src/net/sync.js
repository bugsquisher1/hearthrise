...
//   import { setupSync } from './net/sync.js?v=433';
//   setupSync({
...
import { on, snapshot } from './events.js?v=433';
...
import { resolveActiveSlot } from './accrue.js?v=433';
...
import { balanceState } from './balance.js?v=433';
