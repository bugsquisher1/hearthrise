...
import { SKILLS_DEF } from './data/skills.js?v=285';
import { MONSTERS } from './data/monsters.js?v=285';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=285';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=285';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=285';
import { COMPANIONS } from './data/companions.js?v=285';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=285';
...
import './net/events.js?v=285';
import './net/sync.js?v=285';
import './net/auth.js?v=285';
import './net/supabase-bootstrap.js?v=285';
...
import './config.js?v=285';
import './utils/dom.js?v=285';
import './utils/safe.js?v=285';
import './utils/profile.js?v=285';
import './utils/data-integrity.js?v=285';
import './utils/image-fallback.js?v=285';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=285';
import { setupCompanions } from './features/companions.js?v=285';
import { setupActivitiesGrid } from './features/activities-grid.js?v=285';
import { setupCharacterPage } from './features/character-page.js?v=285';
import { setupCombatRender } from './features/combat-render.js?v=285';
import { setupRecipeBook } from './features/recipe-book.js?v=285';
import { setupItemIndex } from './features/item-index.js?v=285';
