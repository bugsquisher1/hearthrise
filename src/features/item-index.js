...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=475';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=475';
import { ITEM_DESC } from '../data/item-descriptions.js?v=475';
import { SHOP_OFFERS } from '../data/shops.js?v=475';
