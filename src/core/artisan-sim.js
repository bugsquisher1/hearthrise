...
import { resolveArtisanAction, missingInput, recipeInputs, gateOk } from './artisan.js?v=548';
import { bestTool, toolSpeed, toolXpB, toolDouble } from './tools.js?v=548';
import { actionIntervalMs } from './pacing.js?v=548';
import { CHANNEL, channelApplies, rateMult } from './away.js?v=548';
import { sliceSpan } from './skill-sim.js?v=548';
