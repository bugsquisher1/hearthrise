...
//   import { setupSync } from './net/sync.js?v=476';
//   setupSync({
...
import { on, snapshot } from './events.js?v=476';
...
import { resolveActiveSlot } from './accrue.js?v=476';
...
import { balanceState } from './balance.js?v=476';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=476';
import { putClientState } from './client-state.js?v=476';
