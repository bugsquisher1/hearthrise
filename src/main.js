...
import { SKILLS_DEF } from './data/skills.js?v=426';
import { MONSTERS } from './data/monsters.js?v=426';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=426';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=426';
import * as ItemArt from './data/item-art.js?v=426';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=426';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=426';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=426';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=426';
import { COMPANIONS } from './data/companions.js?v=426';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=426';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=426';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=426';
...
import './net/events.js?v=426';
import './net/sync.js?v=426';
...
import './net/dungeon-purchase.js?v=426';
...
import './net/market-history.js?v=426';
import './net/auth.js?v=426';
import './net/supabase-bootstrap.js?v=426';
...
import './net/build-watch.js?v=426';
...
import './config.js?v=426';
import './utils/dom.js?v=426';
import './utils/safe.js?v=426';
import './utils/profile.js?v=426';
import './utils/data-integrity.js?v=426';
import './utils/image-fallback.js?v=426';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=426';
import { setupCompanions } from './features/companions.js?v=426';
import { setupActivitiesGrid } from './features/activities-grid.js?v=426';
import { setupCharacterPage } from './features/character-page.js?v=426';
import { setupCombatRender } from './features/combat-render.js?v=426';
import { setupCombatScreens } from './features/combat-screens.js?v=426';
import { setupRecipeBook } from './features/recipe-book.js?v=426';
import { setupItemIndex } from './features/item-index.js?v=426';
