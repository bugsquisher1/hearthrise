...
import { SKILLS_DEF } from './skills.js?v=442';
import { COMBAT_STYLES } from '../core/styles.js?v=442';
import { GATHER_SKILLS } from '../core/pacing.js?v=442';
import { ARTISAN_SETTLEMENT } from './item-authority.js?v=442';
