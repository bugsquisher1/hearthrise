...
//   import { setupSync } from './net/sync.js?v=455';
//   setupSync({
...
import { on, snapshot } from './events.js?v=455';
...
import { resolveActiveSlot } from './accrue.js?v=455';
...
import { balanceState } from './balance.js?v=455';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=455';
import { putClientState } from './client-state.js?v=455';
