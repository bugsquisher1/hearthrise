...
//   import { setupSync } from './net/sync.js?v=504';
//   setupSync({
...
import { on, snapshot } from './events.js?v=504';
...
import { resolveActiveSlot } from './accrue.js?v=504';
...
import { balanceState } from './balance.js?v=504';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=504';
import { putClientState } from './client-state.js?v=504';
