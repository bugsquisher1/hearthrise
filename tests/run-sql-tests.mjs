...
const ALSO_LINTED = [
  ...
  /* M7, the Bestiary trophy ladder (docs/design/BESTIARY_LADDER.md §4). It creates
     ...
     1f-ii pins that chain as its TENTH link. GENERATED by
     tools/derive-grant-hygiene.mjs (LINKS[9]) from quartermaster-buy's body,
     insertions only. Listed here so `sources` holds it for the derivation walk
     and the grant lints see its create-or-replaces + the two new engine grants. */
...
const HR_GRANT_HYGIENE_CHAIN = [
  ...
  '2026-09-11-quartermaster-buy.sql',
  // link 10 — the Bestiary trophy pair (docs/design/BESTIARY_LADDER.md §4).
  // Chains onto link 9's NOW-LIVE body (quartermaster-buy; its base in
  // tools/derive-grant-hygiene.mjs LINKS[9] is 2026-09-11-quartermaster-buy.sql),
  // so it cannot silently revert links 7-9. An INSERTION (TWO engine grants at
