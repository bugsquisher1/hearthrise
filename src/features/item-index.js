...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=285';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=285';
import { ITEM_DESC } from '../data/item-descriptions.js?v=285';
