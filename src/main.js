...
import { SKILLS_DEF } from './data/skills.js?v=226';
import { MONSTERS } from './data/monsters.js?v=226';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=226';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=226';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=226';
...
import './net/events.js?v=226';
import './net/sync.js?v=226';
import './net/auth.js?v=226';
import './net/supabase-bootstrap.js?v=226';
...
import './config.js?v=226';
import './utils/dom.js?v=226';
import './utils/safe.js?v=226';
import './utils/profile.js?v=226';
import './utils/data-integrity.js?v=226';
import './utils/image-fallback.js?v=226';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=226';
import { setupCompanions } from './features/companions.js?v=226';
import { setupActivitiesGrid } from './features/activities-grid.js?v=226';
import { setupCharacterPage } from './features/character-page.js?v=226';
import { setupCombatRender } from './features/combat-render.js?v=226';
