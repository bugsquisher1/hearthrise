...
//   import { setupSync } from './net/sync.js?v=432';
//   setupSync({
...
import { on, snapshot } from './events.js?v=432';
...
import { resolveActiveSlot } from './accrue.js?v=432';
...
import { balanceState } from './balance.js?v=432';
