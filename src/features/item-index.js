...
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=502';
import { ITEM_DESC } from '../data/item-descriptions.js?v=502';
import { SHOP_OFFERS } from '../data/shops.js?v=502';
