...
//   import { setupSync } from './net/sync.js?v=381';
//   setupSync({
...
import { on, snapshot } from './events.js?v=381';
...
import { resolveActiveSlot } from './accrue.js?v=381';
...
import { balanceState } from './balance.js?v=381';
