...
//
// 2026-09-14: this file was 65,656 lines. The fixtures moved to
// smoke/_harness.js and the tests to smoke/<domain>.js; what is left is the
// registry and runSmokeTest(). Reads game state via window.G (legacy compat).
//
...
//
// THE ORDER OF THE IMPORTS BELOW IS THE ORDER THE SUITE RUNS IN. These tests
// mutate one live G and several depend on what the previous one left behind, so
// the concatenation below is a CONTRACT, not a convenience. Add a domain module
// where its tests used to sit; never re-sort this list to tidy it.
