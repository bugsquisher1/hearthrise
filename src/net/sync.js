...
//   import { setupSync } from './net/sync.js?v=386';
//   setupSync({
...
import { on, snapshot } from './events.js?v=386';
...
import { resolveActiveSlot } from './accrue.js?v=386';
...
import { balanceState } from './balance.js?v=386';
