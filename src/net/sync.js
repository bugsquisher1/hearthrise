...
//   import { setupSync } from './net/sync.js?v=477';
//   setupSync({
...
import { on, snapshot } from './events.js?v=477';
...
import { resolveActiveSlot } from './accrue.js?v=477';
...
import { balanceState } from './balance.js?v=477';
...
import { isBlobRetired, buildResiduePatch } from './capstone.js?v=477';
import { putClientState } from './client-state.js?v=477';
