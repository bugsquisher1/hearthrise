...
import { ARTISAN_RECIPES } from '../data/recipes.js?v=398';
import { TREES, ROCKS, FISH_SPOTS, CROPS } from '../data/gathering.js?v=398';
import { ITEM_DESC } from '../data/item-descriptions.js?v=398';
import { SHOP_OFFERS } from '../data/shops.js?v=398';
