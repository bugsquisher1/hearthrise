...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank } from './accrue.js?v=471';
...
import { applyClientState } from './client-state.js?v=471';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=471';
