...
import * as itemLedger from './item-ledger.js?v=529';
...
import { serverOwnedItem, serverConsumedItem, rebuildItemAuthority, flipArmBlockers, INVENTORY_ARM_ENABLED } from '../data/item-authority.js?v=529';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=529';
...
import * as pendingConsume from './pending-consume.js?v=529';
...
import { DEFAULT_STYLE_KEYS } from '../core/styles.js?v=529';
...
import { notePropertyUnlocks, pickBankRung, isCompleteProgressStatement } from './property-record.js?v=529';
...
import { companionLevelFromXp } from '../core/companion-perk.js?v=529';
