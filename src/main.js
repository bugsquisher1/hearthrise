...
import { SKILLS_DEF } from './data/skills.js?v=348';
import { MONSTERS } from './data/monsters.js?v=348';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=348';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=348';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=348';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=348';
import { COMPANIONS } from './data/companions.js?v=348';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=348';
...
import './net/events.js?v=348';
import './net/sync.js?v=348';
...
import './net/activity.js?v=348';
import './net/auth.js?v=348';
import './net/supabase-bootstrap.js?v=348';
...
import './net/build-watch.js?v=348';
...
import './config.js?v=348';
import './utils/dom.js?v=348';
import './utils/safe.js?v=348';
import './utils/profile.js?v=348';
import './utils/data-integrity.js?v=348';
import './utils/image-fallback.js?v=348';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=348';
import { setupCompanions } from './features/companions.js?v=348';
import { setupActivitiesGrid } from './features/activities-grid.js?v=348';
import { setupCharacterPage } from './features/character-page.js?v=348';
import { setupCombatRender } from './features/combat-render.js?v=348';
import { setupRecipeBook } from './features/recipe-book.js?v=348';
import { setupItemIndex } from './features/item-index.js?v=348';
