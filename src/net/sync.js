...
//   import { setupSync } from './net/sync.js?v=353';
//   setupSync({
...
import { on, snapshot } from './events.js?v=353';
...
import { resolveActiveSlot } from './accrue.js?v=353';
...
import { balanceState } from './balance.js?v=353';
