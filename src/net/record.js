...
import { isServerAccrualEnabled, resolveActiveSlot, reconcileCompanions, reconcileFarm, reconcileTraits, reconcileInventory, reconcileBank } from './accrue.js?v=473';
...
import { applyClientState } from './client-state.js?v=473';
...
import { coverageBoundary, retirePredictions, resetPredictions } from './predict.js?v=473';
