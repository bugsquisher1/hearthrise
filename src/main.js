...
import { SKILLS_DEF } from './data/skills.js?v=485';
import { MONSTERS } from './data/monsters.js?v=485';
import { MONSTER_CLASSES, MONSTER_CLASS_ORDER, resolveMonsterProfile, auditRoster, TIER_BANDS } from './data/monster-classes.js?v=485';
import { wiredIconMap, EXPECTED as MONSTER_ART_EXPECTED, pendingArt } from './data/monster-art.js?v=485';
import * as ItemArt from './data/item-art.js?v=485';
import { ITEMS, foodClassOf, isAutoEatable, foodKindOf, FOOD_KIND_META } from './data/items.js?v=485';
import { TREES, ROCKS, FISH_SPOTS, CROPS, EQUIP_SLOTS, EQUIP_SLOT_META } from './data/gathering.js?v=485';
import { ARTISAN_RECIPES, ARTISAN_CATEGORIES, recipeCategory, categorizeRecipes, isCastleGood } from './data/recipes.js?v=485';
...
import { GEAR_LADDERS, MATERIAL_TIERS } from './data/gear-tiers.js?v=485';
import { COMPANIONS } from './data/companions.js?v=485';
import { RAID_BOSSES } from './data/raid-bosses.js?v=485';
...
import { EFFECT_KINDS, PENDING_SYSTEMS, effectsAreLive, dormantEffects } from './data/item-effects.js?v=485';
import { LIB2_ICON_FILES } from './data/library2-items.js?v=485';
import { BOSSES, BOSS_BY_DUNGEON } from './data/bosses.js?v=485';
...
import { goalDisplayState, GOAL_PHASE } from './core/goal-display.js?v=485';
...
import './net/events.js?v=485';
import './net/sync.js?v=485';
...
import './net/dungeon-purchase.js?v=485';
...
import './net/predict.js?v=485';
import './net/record.js?v=485';
...
import './net/skill-record.js?v=485';
...
import './net/marks-record.js?v=485';
...
import './net/rooms-record.js?v=485';
...
import './net/rested-record.js?v=485';
...
import './net/equipment-record.js?v=485';
...
import './net/market-history.js?v=485';
import './net/auth.js?v=485';
import './net/supabase-bootstrap.js?v=485';
...
import './net/build-watch.js?v=485';
...
import './config.js?v=485';
import './utils/dom.js?v=485';
import './utils/safe.js?v=485';
import './utils/profile.js?v=485';
import './utils/data-integrity.js?v=485';
import './utils/image-fallback.js?v=485';

// 3. Feature modules — each registers itself on setup()
import { setupSmokeTest } from './features/smoke-test.js?v=485';
import { setupCompanions } from './features/companions.js?v=485';
import { setupActivitiesGrid } from './features/activities-grid.js?v=485';
import { setupCharacterPage } from './features/character-page.js?v=485';
import { setupCombatRender } from './features/combat-render.js?v=485';
import { setupCombatScreens } from './features/combat-screens.js?v=485';
import { setupRecipeBook } from './features/recipe-book.js?v=485';
import { setupItemIndex } from './features/item-index.js?v=485';
