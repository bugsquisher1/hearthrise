...
//   import { setupSync } from './net/sync.js?v=434';
//   setupSync({
...
import { on, snapshot } from './events.js?v=434';
...
import { resolveActiveSlot } from './accrue.js?v=434';
...
import { balanceState } from './balance.js?v=434';
