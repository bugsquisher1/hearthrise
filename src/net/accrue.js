...
import * as itemLedger from './item-ledger.js?v=411';
...
import { serverOwnedItem, rebuildItemAuthority } from '../data/item-authority.js?v=411';
...
import { serverAccruedSkill } from '../data/skill-authority.js?v=411';
