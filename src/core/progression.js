...
import { levelFromXp } from './xp.js?v=534';
import { pacedXp } from './pacing.js?v=534';
import { spendRestedCharge } from './rested.js?v=534';
import { advanceToolCarry } from './tools.js?v=534';
